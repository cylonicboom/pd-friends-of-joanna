...
struct mpweapon g_MpWeapons[NUM_MPWEAPONS] = {
    ...
    /*0x01*/
    {WEAPON_FALCON2, AMMOTYPE_PISTOL, 80, 0, 0, 1, 0, MODEL_CHRFALCON2, 256},
    /*0x02*/
    {WEAPON_FALCON2_SILENCER, AMMOTYPE_PISTOL, 80, 0, 0, 1,
     MPFEATURE_WEAPON_FALCON2SILENCED, MODEL_CHRFALCON2SIL, 256},
    /*0x03*/
    {WEAPON_FALCON2_SCOPE, AMMOTYPE_PISTOL, 80, 0, 0, 1,
     MPFEATURE_WEAPON_FALCON2SCOPE, MODEL_CHRFALCON2SCOPE, 256},
    /*0x04*/
    {WEAPON_MAGSEC4, AMMOTYPE_PISTOL, 80, 0, 0, 1, 0, MODEL_CHRLEEGUN1, 256},
    /*0x05*/
    {WEAPON_MAULER, AMMOTYPE_PISTOL, 92, 0, 0, 1, MPFEATURE_WEAPON_MAULER,
     MODEL_CHRMAULER, 256},
    /*0x06*/
    {WEAPON_PHOENIX, AMMOTYPE_PISTOL, 64, 0, 0, 1, MPFEATURE_WEAPON_PHOENIX,
     MODEL_CHRMAIANPISTOL, 256},
    /*0x07*/
    {WEAPON_DY357MAGNUM, AMMOTYPE_MAGNUM, 50, 0, 0, 1, 0, MODEL_CHRDY357, 256},
    /*0x08*/
    {WEAPON_DY357LX, AMMOTYPE_MAGNUM, 50, 0, 0, 1, MPFEATURE_WEAPON_DY357LX,
     MODEL_CHRDY357TRENT, 256},
    /*0x09*/
    {WEAPON_CMP150, AMMOTYPE_SMG, 100, 0, 0, 1, 0, MODEL_CHRCMP150, 256},
    /*0x0a*/
    {WEAPON_CYCLONE, AMMOTYPE_SMG, 150, 0, 0, 1, 0, MODEL_CHRCYCLONE, 256},
    /*0x0b*/
    {WEAPON_CALLISTO, AMMOTYPE_SMG, 150, 0, 0, 1, MPFEATURE_WEAPON_CALLISTO,
     MODEL_CHRMAIANSMG, 256},
    /*0x0c*/
    {WEAPON_RCP120, AMMOTYPE_SMG, 150, 0, 0, 1, MPFEATURE_WEAPON_RCP120,
     MODEL_CHRRCP120, 256},
    /*0x0d*/
    {WEAPON_LAPTOPGUN, AMMOTYPE_SMG, 150, 0, 0, 1, MPFEATURE_WEAPON_LAPTOPGUN,
     MODEL_CHRPCGUN, 256},
    /*0x0e*/
    {WEAPON_DRAGON, AMMOTYPE_RIFLE, 150, 0, 0, 1, 0, MODEL_CHRDRAGON, 256},
    /*0x0f*/
    {WEAPON_K7AVENGER, AMMOTYPE_RIFLE, 150, 0, 0, 1, MPFEATURE_WEAPON_K7AVENGER,
     MODEL_CHRAVENGER, 256},
    /*0x10*/ {WEAPON_AR34, AMMOTYPE_RIFLE, 100, 0, 0, 1, 0, MODEL_CHRAR34, 256},
    /*0x11*/
    {WEAPON_SUPERDRAGON, AMMOTYPE_RIFLE, 150, AMMOTYPE_DEVASTATOR, 16, 1,
     MPFEATURE_WEAPON_SUPERDRAGON, MODEL_CHRSUPERDRAGON, 256},
    /*0x12*/
    {WEAPON_SHOTGUN, AMMOTYPE_SHOTGUN, 16, 0, 0, 1, MPFEATURE_WEAPON_SHOTGUN,
     MODEL_CHRSHOTGUN, 256},
    /*0x13*/
    {WEAPON_REAPER, AMMOTYPE_REAPER, 200, 0, 0, 1, MPFEATURE_WEAPON_REAPER,
     MODEL_CHRSKMINIGUN, 256},
    /*0x14*/
    {WEAPON_SNIPERRIFLE, AMMOTYPE_RIFLE, 50, 0, 0, 1, 0, MODEL_CHRSNIPERRIFLE,
     256},
    /*0x15*/
    {WEAPON_FARSIGHT, AMMOTYPE_FARSIGHT, 10, 0, 0, 1, MPFEATURE_WEAPON_FARSIGHT,
     MODEL_CHRZ2020, 256},
    /*0x16*/
    {WEAPON_DEVASTATOR, AMMOTYPE_DEVASTATOR, 16, 0, 0, 1,
     MPFEATURE_WEAPON_DEVASTATOR, MODEL_CHRDEVASTATOR, 256},
    /*0x17*/
    {WEAPON_ROCKETLAUNCHER, AMMOTYPE_ROCKET, 3, 0, 0, 1, 0, MODEL_CHRDYROCKET,
     256},
    /*0x18*/
    {WEAPON_SLAYER, AMMOTYPE_ROCKET, 3, 0, 0, 1, MPFEATURE_WEAPON_SLAYER,
     MODEL_CHRSKROCKET, 256},
#if !((VERSION == VERSION_JPN_FINAL) && defined(PLATFORM_N64))
    /*0x19*/
    {WEAPON_COMBATKNIFE, AMMOTYPE_KNIFE, 5, 0, 0, 1, 0, MODEL_CHRKNIFE, 256},
#endif
    /*0x1a*/
    {WEAPON_CROSSBOW, AMMOTYPE_CROSSBOW, 10, 0, 0, 1, MPFEATURE_WEAPON_CROSSBOW,
     MODEL_CHRCROSSBOW, 256},
    /*0x1b*/
    {WEAPON_TRANQUILIZER, AMMOTYPE_SEDATIVE, 50, 0, 0, 1,
     MPFEATURE_WEAPON_TRANQUILIZER, MODEL_CHRDRUGGUN, 256},
    /*0x1c*/
    {WEAPON_GRENADE, AMMOTYPE_GRENADE, 5, 0, 0, 0, 0, MODEL_CHRGRENADE, 256},
    /*0x1d*/
    {WEAPON_NBOMB, AMMOTYPE_NBOMB, 3, 0, 0, 0, MPFEATURE_WEAPON_NBOMB,
     MODEL_CHRNBOMB, 256},
    /*0x1e*/
    {WEAPON_TIMEDMINE, AMMOTYPE_TIMED_MINE, 5, 0, 0, 0, 0, MODEL_CHRTIMEDMINE,
     384},
    /*0x1f*/
    {WEAPON_PROXIMITYMINE, AMMOTYPE_PROXY_MINE, 5, 0, 0, 0,
     MPFEATURE_WEAPON_PROXIMITYMINE, MODEL_CHRPROXIMITYMINE, 384},
    /*0x20*/
    {WEAPON_REMOTEMINE, AMMOTYPE_REMOTE_MINE, 5, 0, 0, 0,
     MPFEATURE_WEAPON_REMOTEMINE, MODEL_CHRREMOTEMINE, 384},
    /*0x21*/
    {WEAPON_LASER, 0, 0, 0, 0, 1, MPFEATURE_WEAPON_LASER, MODEL_CHRLASER, 512},
#ifndef PLATFORM_N64
    // fix X-Ray Scanner model
    /*0x22*/
    {WEAPON_XRAYSCANNER, 0, 0, 0, 0, 1, MPFEATURE_WEAPON_XRAYSCANNER,
     MODEL_XRAYSPECS, 256},
    ...
    /*0x22*/
    {WEAPON_XRAYSCANNER, 0, 0, 0, 0, 1, MPFEATURE_WEAPON_XRAYSCANNER,
     MODEL_CHRNIGHTSIGHT, 256},
#endif
    /*0x25*/
    {WEAPON_CLOAKINGDEVICE, 0, 0, 0, 0, 1, MPFEATURE_WEAPON_CLOAKINGDEVICE,
     MODEL_CHRCLOAKER, 256},
    /*0x26*/
    {WEAPON_COMBATBOOST, 0, 0, 0, 0, 1, MPFEATURE_WEAPON_COMBATBOOST,
     MODEL_CHRSPEEDPILL, 256},
#ifndef PLATFORM_N64
    ...
    /*0x29*/
    {WEAPON_KL01313, AMMOTYPE_SMG, 100, 0, 0, 1, 0, MODEL_CHRSKORPION, 256},
    /*0x2a*/
    {WEAPON_KF7SPECIAL, AMMOTYPE_RIFLE, 100, 0, 0, 1, 0, MODEL_CHRKALASH, 256},
...
#endif
    /*0x2f*/
    {WEAPON_MPSHIELD, 0, 0, 0, 0, 1, MPFEATURE_WEAPON_SHIELD, MODEL_CHRSHIELD,
     256},
...
static void mpExtendedProfileInitHandicap(s32 profileindex, s32 playernum) {
  g_PlayerConfigsArray[playernum].handicap =
      &g_ExtendedProfiles[profileindex].handicap_prop.u8;
}

static void mpExtendedProfileInitClassicSight(s32 profileindex, s32 playernum) {
  g_PlayerConfigsArray[playernum].classicsight =
      &g_ExtendedProfiles[profileindex].classicsight_prop.u8;
}

static void mpExtendedProfileInitShowLives(s32 profileindex, s32 playernum) {
  g_PlayerConfigsArray[playernum].showlives =
      &g_ExtendedProfiles[profileindex].showlives_prop.u8;
}

static void mpExtendedProfileInitInGameSubtitles(s32 profileindex,
                                                 s32 playernum) {
  g_PlayerConfigsArray[playernum].ingamesubtitles =
      &g_ExtendedProfiles[profileindex].ingamesubtitles_prop.u8;
}

static void mpExtendedProfileInitCutsceneSubtitles(s32 profileindex,
                                                   s32 playernum) {
  g_PlayerConfigsArray[playernum].cutscenesubtitles =
      &g_ExtendedProfiles[profileindex].cutscenesubtitles_prop.u8;
}

static void mpExtendedProfileInitShowMissionTime(s32 profileindex,
                                                 s32 playernum) {
  g_PlayerConfigsArray[playernum].showmissiontime =
      &g_ExtendedProfiles[profileindex].showmissiontime_prop.u8;
}

static void mpExtendedProfileInitShowPlayerName(s32 profileindex,
                                                s32 playernum) {
  g_PlayerConfigsArray[playernum].showplayername =
      &g_ExtendedProfiles[profileindex].showplayername_prop.u8;
}

static void mpExtendedProfileInitTeamAgentIndex(s32 profileindex,
                                                s32 playernum) {
  s32 val = g_ExtendedProfiles[profileindex].teamagentindex_prop.s32;
  if (val < 0 ||
      g_ExtendedProfiles[profileindex].fileguid.deviceserial == 0xFFFF) {
    val = playernum;
...
static inline s32 iniAllocateProfileSlot(struct fileguid *fileguid) {
  ...
  if (index < 0) {
    ...
    g_ExtendedProfiles[index] =
        (struct extplayerprofile)PLAYER_EXT_PROFILE_DEFAULT;
...
static inline s32 mpPlayerGetIndexFromFileGuid(struct fileguid *fileguid) {
  ...
  for (i = 0; i < MAX_PLAYERS; i++) {
    if (g_PlayerConfigsArray[i].fileguid.fileid == fileguid->fileid &&
        g_PlayerConfigsArray[i].fileguid.deviceserial ==
            fileguid->deviceserial) {
      return i;
    }
  }
...
static inline s32 iniBindProfileProperties(struct fileguid *fileguid, s32 arg0,
                                           s32 playernum) {
  s32 i;
  ...
  if (arg0 & 1) {
    sprintf(playerbuf, "MpPlayer.%x-%x", fileguid->deviceserial,
            fileguid->fileid);
    playerslug = playerbuf;
  }

  s32 configindex = iniAllocateProfileSlot(fileguid);
  ...
  for (i = 0; i < ARRAYCOUNT(g_ExtendedProfileProperties); i++) {
    ...
    case CFG_U8:
      if (playerslug) {
        g_ExtendedProfiles[configindex].ptr[i + 1] =
            (extplayerprop)g_ExtendedProfileProperties[i].initialvalue_u8;
        configRegisterU8Int(
            key, (u8 *)&g_ExtendedProfiles[configindex].ptr[i + 1].u8,
            g_ExtendedProfileProperties[i].min_u8,
            g_ExtendedProfileProperties[i].max_u8);
      }
      break;
    case CFG_S32:
      if (playerslug) {
        g_ExtendedProfiles[configindex].ptr[i + 1] =
            (extplayerprop)g_ExtendedProfileProperties[i].initialvalue_s32;
        configRegisterInt(
            key, (s32 *)&g_ExtendedProfiles[configindex].ptr[i + 1].s32,
            g_ExtendedProfileProperties[i].min_s32,
            g_ExtendedProfileProperties[i].max_s32);
      }
      break;
    case CFG_U32:
      if (playerslug) {
        g_ExtendedProfiles[configindex].ptr[i + 1] =
            (extplayerprop)g_ExtendedProfileProperties[i].initialvalue_u32;
        configRegisterUInt(
            key, (u32 *)&g_ExtendedProfiles[configindex].ptr[i + 1].u32,
            g_ExtendedProfileProperties[i].min_u32,
            g_ExtendedProfileProperties[i].max_u32);
      }
      break;
    case CFG_F32:
      if (playerslug) {
        g_ExtendedProfiles[configindex].ptr[i + 1] =
            (extplayerprop)g_ExtendedProfileProperties[i].initialvalue_f32;
        configRegisterFloat(
            key, (f32 *)&g_ExtendedProfiles[configindex].ptr[i + 1].f32,
            g_ExtendedProfileProperties[i].min_f32,
            g_ExtendedProfileProperties[i].max_f32);
      }
      break;
    case CFG_STR:
      if (playerslug) {
        g_ExtendedProfiles[configindex].ptr[i + 1] =
            (extplayerprop)g_ExtendedProfileProperties[i].initialvalue_str;
        configRegisterString(
            key, (char *)g_ExtendedProfiles[configindex].ptr[i + 1].string,
            sizeof(g_ExtendedProfiles[configindex].ptr[i]));
      }
      break;
    }
    if (playerslug)
...
s32 iniRegisterPlayerSave(struct fileguid *fileguid, s32 arg0, s32 playernum) {
  return iniBindProfileProperties(fileguid, arg0, playernum);
}
...
void mpReset(void) {
  ...
  if (g_MissionConfig.isteam || g_Vars.coopplayernum >= 0 ||
    ...
    for (i = 0; i < MAX_PLAYERS; i++) {
      if (g_MpSetup.chrslots & (1 << i)) {
        ...
        if (((g_Vars.coopplayernum >= 0 ||
              g_Vars.bondplayernum == g_Vars.currentplayernum) &&
             g_Vars.coopradaron) ||
            (g_Vars.antiplayernum >= 0 && g_Vars.antiradaron)) {
...
static inline void iniFlushRegistrationQueue() {
  for (s32 i = 0; i < g_NumGuidsToProcess; i++) {
    printf("Processing guid %x\n", g_GuidsToProcess[i].fileid);
    iniBindProfileProperties(&g_GuidsToProcess[i], 1, -1);
  }
  g_NumGuidsToProcess = 0;
}

void iniProcessPendingProfiles(void) { iniFlushRegistrationQueue(); }
...
void mpPlayerSetDefaults(s32 playernum, bool autonames) {
  ...
  g_PlayerConfigsArray[playernum].options =
      ...
      OPTION_FORWARDPITCH
#endif
      | OPTION_SIGHTONSCREEN | OPTION_AUTOAIM | OPTION_AMMOONSCREEN |
      OPTION_SHOWGUNFUNCTION | OPTION_HEADROLL | OPTION_0100 |
      OPTION_ALWAYSSHOWTARGET | OPTION_SHOWZOOMRANGE;
  ...
  g_PlayerConfigsArray[playernum].base.mpheadnum =
      mpGetMpheadnumByMpbodynum(g_PlayerConfigsArray[playernum].base.mpbodynum);
  g_PlayerConfigsArray[playernum].base.displayoptions =
...
void mpInit(bool resetplayers) {
  ...
  g_MpSetup.options = MPOPTION_DISPLAYTEAM | MPOPTION_KILLSSCORE |
                      MPOPTION_HTB_HIGHLIGHTBRIEFCASE |
                      MPOPTION_HTB_SHOWONRADAR | MPOPTION_CTC_SHOWONRADAR |
                      MPOPTION_KOH_HILLONRADAR | MPOPTION_KOH_MOBILEHILL |
                      MPOPTION_00010000 | MPOPTION_HTM_HIGHLIGHTTERMINAL |
                      MPOPTION_HTM_SHOWONRADAR | MPOPTION_PAC_HIGHLIGHTTARGET |
...
void mpSetDefaultNamesIfEmpty(void) {
  ...
  for (i = 0; i < ARRAYCOUNT(g_BossFile.teamnames); i++) {
    if (g_BossFile.teamnames[i][0] == '\0') {
      strcpy(g_BossFile.teamnames[i],
             langGet(L_OPTIONS_008 + i)); // "Red", "Yellow" etc
    }
  }
...
s32 mpGetTeamRankings(struct ranking *rankings) {
  ...
  do {
    ...
    for (i = 0; i < MAX_TEAMS; i++) {
      if (apparentscores[7 - i] > -8000 &&
          rankablescores[7 - i] >= bestrankablescore) {
        thisteamnum = 7 - i;
...
s32 func0f189058(bool full) {
  return mpCountWeaponSetThing(full ? ARRAYCOUNT(g_MpWeaponSets) + 3
                                    : ARRAYCOUNT(g_MpWeaponSets));
}
...
void mpSetRandomWeapons(u8 weapons[]) {
  ...
  if (index == 0) {
    weapons[0] = 0; // optionindex (shifted by unlocked weapons, but usually 0
                    // is "Nothing")
...
void mpApplyWeaponSet(void) {
  ...
  if (g_MpWeaponSetNum >= 0 && g_MpWeaponSetNum < ARRAYCOUNT(g_MpWeaponSets)) {
    if (challengeIsFeatureUnlocked(
            g_MpWeaponSets[g_MpWeaponSetNum].requirefeatures[0]) &&
        challengeIsFeatureUnlocked(
            g_MpWeaponSets[g_MpWeaponSetNum].requirefeatures[1]) &&
        challengeIsFeatureUnlocked(
            g_MpWeaponSets[g_MpWeaponSetNum].requirefeatures[2]) &&
        challengeIsFeatureUnlocked(
            g_MpWeaponSets[g_MpWeaponSetNum].requirefeatures[3])) {
    ...
    for (i = 0; i < ARRAYCOUNT(g_MpSetup.weapons); i++) {
      mpSetWeaponSlot(i,
                      randomweapons[rngRandom() % g_MpWeaponRandomFilterNum]);
    }
#endif
...
void mpSetPaused(u8 mode) { g_MpSetup.paused = mode; }
...
Gfx *mpRenderModalText(Gfx *gdl) {
  ...
  if (g_MpSetup.paused == MPPAUSEMODE_PAUSED) {
...
#if VERSION >= VERSION_JPN_FINAL
    textMeasure(&textheight, &textwidth, text, g_CharsHandelGothicSm,
    ...
    textMeasure(&textheight, &textwidth, text, g_CharsHandelGothicSm,
                g_FontHandelGothicSm, 0);
#else
    textMeasure(&textheight, &textwidth, text, g_CharsHandelGothicMd,
                g_FontHandelGothicMd, 0);
#endif
    x -= textwidth / 2;

#if VERSION >= VERSION_JPN_FINAL
    gdl = func0f1574d0jf(gdl, &x, &y, text, g_CharsHandelGothicSm,
                         g_FontHandelGothicSm, (red << 24) | 0x00ff00ff,
                         0x000000ff, viGetWidth(), viGetWidth(), 0, 0);
#elif PAL
    gdl = textRender(gdl, &x, &y, text, g_CharsHandelGothicSm,
                     g_FontHandelGothicSm, (red << 24) | 0x00ff00ff, 0x000000ff,
                     viGetWidth(), viGetWidth(), 0, 0);
#else
    gdl = textRender(gdl, &x, &y, text, g_CharsHandelGothicMd,
                     g_FontHandelGothicMd, (red << 24) | 0x00ff00ff, 0x000000ff,
                     viGetWidth(), viGetWidth(), 0, 0);
#endif
  ...
  if (!g_MainIsEndscreen && g_MpSetup.paused == MPPAUSEMODE_UNPAUSED &&
      g_Vars.currentplayer->isdead && g_Vars.currentplayer->redbloodfinished &&
      g_Vars.currentplayer->deathanimfinished &&
      !(g_Vars.coopplayers[g_Vars.currentplayernum] &&
      ...
      !(g_MissionConfig.lives > 0 &&
        g_Vars.currentplayer->livesremaining == 0) &&
...
#if VERSION >= VERSION_JPN_FINAL
    gdl = func0f1574d0jf(gdl, &x, &y, text, g_CharsHandelGothicSm,
                         g_FontHandelGothicSm, 0xff0000ff, 0x000000ff,
                         viGetWidth(), viGetWidth(), 0, 0);
#else
    gdl = textRender(gdl, &x, &y, text, g_CharsHandelGothicSm,
                     g_FontHandelGothicSm, 0xff0000ff, 0x000000ff, viGetWidth(),
                     viGetWidth(), 0, 0);
#endif
...
struct mpweaponset g_MpWeaponSets[12] = {
    {/*0x00*/ L_MPWEAPONS_055,
     {WEAPON_FALCON2, WEAPON_MAGSEC4, WEAPON_PHOENIX, WEAPON_MAULER,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_DY357MAGNUM,
     WEAPON_MPSHIELD,
     WEAPON_DISABLED}, // Pistols
    {/*0x01*/ L_MPWEAPONS_054,
     {WEAPON_FALCON2, WEAPON_CMP150, WEAPON_LAPTOPGUN, WEAPON_AR34,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_AR34,
     WEAPON_MPSHIELD,
     WEAPON_DISABLED}, // Automatics
    {/*0x02*/ L_MPWEAPONS_053,
     {WEAPON_MAGSEC4, WEAPON_DY357MAGNUM, WEAPON_SHOTGUN, WEAPON_RCP120,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_AR34,
     WEAPON_MPSHIELD,
     WEAPON_DISABLED}, // Power
    {/*0x03*/ L_MPWEAPONS_052,
     {WEAPON_PHOENIX, WEAPON_CYCLONE, WEAPON_CALLISTO, WEAPON_FARSIGHT,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // FarSight
    {/*0x04*/ L_MPWEAPONS_051,
     {WEAPON_FALCON2, WEAPON_CMP150, WEAPON_DRAGON, WEAPON_TRANQUILIZER,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // Tranquilizer
    {/*0x05*/ L_MPWEAPONS_050,
     {WEAPON_MAULER, WEAPON_K7AVENGER, WEAPON_REAPER, WEAPON_SUPERDRAGON,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     {MPFEATURE_WEAPON_SUPERDRAGON, MPFEATURE_WEAPON_MAULER,
     ...
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // Heavy
    {/*0x06*/ L_MPWEAPONS_049,
     ...
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // Golden Magnum
    {/*0x07*/ L_MPWEAPONS_048,
     {WEAPON_DEVASTATOR, WEAPON_DEVASTATOR, WEAPON_SUPERDRAGON,
      WEAPON_SUPERDRAGON, WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // Explosive
    {/*0x08*/ L_MPWEAPONS_047,
     {WEAPON_MAGSEC4, WEAPON_CMP150, WEAPON_AR34, WEAPON_DEVASTATOR,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // Grenade Launcher
    {/*0x09*/ L_MPWEAPONS_046,
     {WEAPON_MAULER, WEAPON_CYCLONE, WEAPON_DRAGON, WEAPON_ROCKETLAUNCHER,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_MPSHIELD,
     WEAPON_DISABLED}, // Rocket Launcher
    {/*0x0a*/ L_MPWEAPONS_045,
     {WEAPON_MAGSEC4, WEAPON_LAPTOPGUN, WEAPON_K7AVENGER, WEAPON_PROXIMITYMINE,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     {MPFEATURE_WEAPON_LAPTOPGUN, MPFEATURE_WEAPON_K7AVENGER,
      MPFEATURE_WEAPON_PROXIMITYMINE, 0},
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED,
     WEAPON_DISABLED}, // Proximity Mine
#if (VERSION == VERSION_JPN_FINAL) && defined(PLATFORM_N64)
    {/*0x0b*/ L_MPWEAPONS_044,
     {WEAPON_TIMEDMINE, WEAPON_CROSSBOW, WEAPON_TIMEDMINE, WEAPON_CROSSBOW,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     ...
     WEAPON_TIMEDMINE,
     WEAPON_MPSHIELD,
     WEAPON_DISABLED}, // Close Combat
#else
    {/*0x0b*/ L_MPWEAPONS_044,
     {WEAPON_COMBATKNIFE, WEAPON_COMBATKNIFE, WEAPON_TIMEDMINE, WEAPON_CROSSBOW,
      WEAPON_MPSHIELD, WEAPON_DISABLED},
     {MPFEATURE_WEAPON_CROSSBOW, 0, 0, 0},
     WEAPON_COMBATKNIFE,
     WEAPON_COMBATKNIFE,
...
struct mphead g_MpBeauHeads[] = {
    ...
    {HEAD_BEAU2, 0}, {HEAD_BEAU3, 0}, {HEAD_BEAU4, 0},
    {HEAD_BEAU5, 0}, {HEAD_BEAU6, 0},
};
...
u32 g_BotHeads[] = {
    MPHEAD_JON,      MPHEAD_BEAU1,    MPHEAD_ROSS,     MPHEAD_MARK2,
    MPHEAD_CHRIST,   MPHEAD_RUSS,     MPHEAD_DARLING,  MPHEAD_BRIAN,
    MPHEAD_JAMIE,    MPHEAD_DUNCAN2,  MPHEAD_KEITH,    MPHEAD_STEVEM,
    MPHEAD_GRANT,    MPHEAD_PENNY,    MPHEAD_DAVEC,    MPHEAD_JONES,
    MPHEAD_GRAHAM,   MPHEAD_ROBERT,   MPHEAD_NEIL2,    MPHEAD_SHAUN,
    MPHEAD_ROBIN,    MPHEAD_COOK,     MPHEAD_PRYCE,    MPHEAD_SILKE,
    MPHEAD_SMITH,    MPHEAD_GARETH,   MPHEAD_MURCHIE,  MPHEAD_WONG,
    MPHEAD_CARTER,   MPHEAD_TINTIN,   MPHEAD_MUNTON,   MPHEAD_STAMPER,
    MPHEAD_PHELPS,   MPHEAD_ALEX,     MPHEAD_JULIANNE, MPHEAD_LAURA,
    MPHEAD_EDMCG,    MPHEAD_ANKA,     MPHEAD_LESLIE_S, MPHEAD_MATT_C,
    MPHEAD_PEER_S,   MPHEAD_EILEEN_T, MPHEAD_ANDY_R,   MPHEAD_BEN_R,
    MPHEAD_STEVE_K,  MPHEAD_SANCHEZ,  MPHEAD_TIM,      MPHEAD_KEN,
    MPHEAD_EILEEN_H, MPHEAD_SCOTT_H,  MPHEAD_JOEL,     MPHEAD_GRIFFEY,
#if VERSION != VERSION_JPN_FINAL
    MPHEAD_MOTO,
#endif
};
...
struct botprofile g_BotProfiles[] = {
    ...
    {BOTTYPE_GENERAL, BOTDIFF_HARD, L_MISC_091, MPBODY_DDSHOCK,
     MPFEATURE_BOTDIFF_HARD},
    {BOTTYPE_GENERAL, BOTDIFF_PERFECT, L_MISC_092, MPBODY_STRIPES,
     MPFEATURE_BOTDIFF_PERFECT},
    {BOTTYPE_GENERAL, BOTDIFF_DARK, L_MISC_093, MPBODY_MOORE,
...
struct mpbody g_MpBodiesOriginal[] = {
    // global body ID,                name,            head,             require
    // feature
    /*0x00*/ {BODY_DARK_COMBAT, L_OPTIONS_016, HEAD_DARK_COMBAT, 0},
    /*0x01*/
    {BODY_DARK_TRENCH, L_OPTIONS_017, HEAD_DARK_COMBAT, MPFEATURE_CHR_JOTRENCH},
    /*0x02*/
    {BODY_DARK_FROCK, L_OPTIONS_018, HEAD_DARK_FROCK, MPFEATURE_CHR_CI},
    /*0x03*/
    {BODY_DARK_RIPPED, L_OPTIONS_019, HEAD_DARK_FROCK, MPFEATURE_CHR_CI},
    /*0x04*/
    {BODY_DARK_AF1, L_OPTIONS_020, HEAD_DARK_COMBAT, MPFEATURE_CHR_AF1},
    /*0x05*/
    {BODY_DARK_LEATHER, L_MPWEAPONS_156, HEAD_DARK_COMBAT, MPFEATURE_CHR_G5},
    /*0x06*/
    {BODY_DARK_NEGOTIATOR, L_MPWEAPONS_157, HEAD_DARK_COMBAT,
     MPFEATURE_CHR_VILLACHRS},
    /*0x07*/
    {BODY_DARKWET, L_OPTIONS_021, HEAD_DARKAQUA, MPFEATURE_CHR_PELAGIC},
    /*0x08*/
    {BODY_DARKAQUALUNG, L_OPTIONS_022, HEAD_DARKAQUA, MPFEATURE_CHR_PELAGIC},
    /*0x09*/
    {BODY_DARKSNOW, L_OPTIONS_023, HEAD_DARK_SNOW, MPFEATURE_CHR_DARKSNOW},
    /*0x0a*/
    {BODY_DARKLAB, L_OPTIONS_024, HEAD_DARK_COMBAT, MPFEATURE_CHR_INFILTRATION},
    ...
    /*0x0d*/
    {BODY_ELVISWAISTCOAT, L_MPWEAPONS_158, HEAD_ELVIS, MPFEATURE_CHR_ELVIS},
    /*0x0e*/ {BODY_CARRINGTON, L_OPTIONS_027, HEAD_CARRINGTON, 0},
    /*0x0f*/
    {BODY_CARREVENINGSUIT, L_OPTIONS_028, HEAD_CARRINGTON, MPFEATURE_CHR_CI},
    /*0x10*/
    {BODY_MRBLONDE, L_OPTIONS_029, HEAD_MRBLONDE, MPFEATURE_CHR_MRBLONDE},
    /*0x11*/ {BODY_CASSANDRA, L_OPTIONS_030, HEAD_CASSANDRA, 0},
    /*0x12*/ {BODY_TRENT, L_OPTIONS_031, HEAD_TRENT, MPFEATURE_CHR_TRENT},
    /*0x13*/
    {BODY_JONATHAN, L_OPTIONS_032, HEAD_JONATHAN, MPFEATURE_CHR_JONATHAN},
    ...
    /*0x1d*/
    {BODY_OFFICEWORKER, L_OPTIONS_042, 1000, MPFEATURE_CHR_OFFICEWORKER},
    /*0x1e*/
    {BODY_OFFICEWORKER2, L_OPTIONS_043, 1000, MPFEATURE_CHR_OFFICEWORKER},
    /*0x1f*/ {BODY_NEGOTIATOR, L_OPTIONS_044, 1000, MPFEATURE_CHR_VILLACHRS},
    /*0x20*/
    {BODY_DDSNIPER, L_OPTIONS_045, HEAD_DDSNIPER, MPFEATURE_CHR_VILLACHRS},
    ...
    /*0x25*/
    {BODY_AREA51GUARD, L_OPTIONS_050, 1000, MPFEATURE_CHR_INFILTRATION},
    ...
    /*0x2e*/
    {BODY_ALASKAN_GUARD, L_OPTIONS_059, 1000, MPFEATURE_CHR_ALASKANGUARD},
    ...
    /*0x35*/
    {BODY_PRES_SECURITY, L_OPTIONS_066, 1000, MPFEATURE_CHR_PRESSECURITY},
    /*0x36*/
    {BODY_PRESIDENT_CLONE2, L_OPTIONS_067, HEAD_PRESIDENT,
     MPFEATURE_CHR_PRESCLONE},
    /*0x37*/ {BODY_PELAGIC_GUARD, L_OPTIONS_068, 1000, MPFEATURE_CHR_PELAGIC},
    /*0x38*/
    {BODY_MAIAN_SOLDIER, L_OPTIONS_069, HEAD_MAIAN_S, MPFEATURE_CHR_ELVIS},
...
u32 g_MpMaleHeads[] = {
    HEAD_JON,     HEAD_BEAU1,   HEAD_ROSS,    HEAD_MARK2,   HEAD_CHRIST,
    HEAD_RUSS,    HEAD_DARLING, HEAD_BRIAN,   HEAD_JAMIE,   HEAD_DUNCAN2,
    HEAD_KEITH,   HEAD_STEVEM,  HEAD_GRANT,   HEAD_PENNY,   HEAD_DAVEC,
    HEAD_JONES,   HEAD_GRAHAM,  HEAD_NEIL2,   HEAD_SHAUN,   HEAD_ROBIN,
    HEAD_COOK,    HEAD_PRYCE,   HEAD_SILKE,   HEAD_SMITH,   HEAD_GARETH,
    HEAD_MURCHIE, HEAD_WONG,    HEAD_CARTER,  HEAD_TINTIN,  HEAD_MUNTON,
    HEAD_STAMPER, HEAD_PHELPS,  HEAD_EDMCG,   HEAD_MATT_C,  HEAD_PEER_S,
    HEAD_ANDY_R,  HEAD_BEN_R,   HEAD_STEVE_K, HEAD_SANCHEZ, HEAD_TIM,
    HEAD_KEN,     HEAD_SCOTT_H, HEAD_JOEL,
#if VERSION != VERSION_JPN_FINAL
    HEAD_MOTO,
#endif
};
...
u32 g_MpFemaleHeads[] = {
    HEAD_ALEX,     HEAD_JULIANNE, HEAD_LAURA,    HEAD_ANKA,
    HEAD_LESLIE_S, HEAD_EILEEN_T, HEAD_EILEEN_H,
};

/**
 * Flush in-game stats for the current player into their mp profile.
 * Called once per player at team mission end (parity with CS
 * mpCalculateAwards).
 */
void teamCalculateAwards(void) {
  if (!g_CheatsActiveBank0 && !g_CheatsActiveBank1) {
    ...
    mpplayer->damagedealt +=
        (u32)(g_Vars.currentplayerstats->damtransmitted / 0.1f);
    mpplayer->painreceived +=
        (u32)(g_Vars.currentplayerstats->damreceived / 0.1f);
    ...
    if (numshots > 0) {
      ...
      if (mpplayer->gamesplayed < 2) {
        ...
        mpplayer->accuracy =
            ((accuracyfrac * 0.3f) + (mpplayer->accuracy / 1000.0f * 0.7f)) *
            1000.0f;
      }
    }
  }
...
void mpCalculateAwards(void) {
...
#if VERSION >= VERSION_NTSC_1_0
  numteams = (g_MpSetup.options & MPOPTION_TEAMSENABLED)
                 ? mpGetTeamRankings(teamrankings)
                 : 0;
#endif
  ...
  for (i = 0; i < playercount; i++) {
    ...
    metrics[i].numheadshots =
        mpstatsGetPlayerShotCountByRegion(SHOTREGION_HEAD);
    ...
    metrics[i].ksratio =
        metrics[i].numkills * 100.0f / (metrics[i].numshots + 1.0f);
    metrics[i].kdratio =
        metrics[i].numkills * 100.0f / (metrics[i].numdeaths + 1.0f);
    metrics[i].backshotcount = g_Vars.playerstats[i].backshotcount;
    metrics[i].drawplayercount = g_Vars.playerstats[i].drawplayercount;
    metrics[i].avgkmperhour = g_Vars.playerstats[i].distance / 100000.0f /
                              ((duration60 + 1) / (3600.0f * 60.0f));
    ...
    if (!g_CheatsActiveBank0 && !g_CheatsActiveBank1) {
      ...
      if (metrics[i].numshots > 0) {
        if (mpplayer->gamesplayed < 2) {
          ...
          mpplayer->accuracy = ((metrics[i].accuracyfrac * 0.3f) +
                                (mpplayer->accuracy / 1000.0f * 0.7f)) *
                               1000.0f;
        }
      }
#else
      ...
      mpplayer->damagedealt +=
          (u32)(g_Vars.playerstats[i].damtransmitted / 0.1f);
...
#if VERSION >= VERSION_NTSC_1_0
      if ((numchrs >= 2 && (g_MpSetup.options & MPOPTION_TEAMSENABLED) == 0) ||
          numteams >= 2)
#else
      if (numchrs >= 2)
#endif
      {
...
#endif
            {
              ...
              if (othermpchr->rankablescore == mpplayer->base.rankablescore &&
                  ...
                  !((g_MpSetup.options & MPOPTION_TEAMSENABLED) &&
                    othermpchr->team == mpplayer->base.team)) {
                lost = true;
              }
            }
          }
        ...
        if (((g_MpSetup.options & MPOPTION_TEAMSENABLED) == 0 &&
             numchrs == mpplayer->base.placement + 1) ||
            ((g_MpSetup.options & MPOPTION_TEAMSENABLED) &&
             numteams == mpplayer->base.placement + 1))
#else
  ...
  i = mpFindMaxInt(playercount, metrics[0].numsuicides, metrics[1].numsuicides,
                   metrics[2].numsuicides, metrics[3].numsuicides);

  if (metrics[i].numsuicides > 0) {
    metrics[i].awards |= AWARD_MOSTSUICIDAL;
  }

  i = mpFindMinInt(playercount, metrics[0].numshots, metrics[1].numshots,
                   metrics[2].numshots, metrics[3].numshots);

  if (metrics[i].numshots < 100) {
    metrics[i].awards |= AWARD_WHONEEDSAMMO;
  }

  i = mpFindMinFloat(playercount, metrics[0].armourcount,
                     metrics[1].armourcount, metrics[2].armourcount,
                     metrics[3].armourcount);

  if (metrics[i].armourcount <= 2.0f) {
    metrics[i].awards |= AWARD_LEASTSHIELDED;
  }

  i = mpFindMaxFloat(playercount, metrics[0].armourcount,
                     metrics[1].armourcount, metrics[2].armourcount,
                     metrics[3].armourcount);
  ...
  i = mpFindMaxInt(playercount, metrics[0].numheadshots,
                   metrics[1].numheadshots, metrics[2].numheadshots,
                   metrics[3].numheadshots);

  if (metrics[i].numheadshots > 0) {
    metrics[i].awards |= AWARD_MARKSMANSHIP;
  }

  i = mpFindMaxFloat(playercount, metrics[0].ksratio, metrics[1].ksratio,
                     metrics[2].ksratio, metrics[3].ksratio);

  if (metrics[i].ksratio > 0.0f) {
    metrics[i].awards |= AWARD_MOSTPROFESSIONAL;
  }

  i = mpFindMaxFloat(playercount, metrics[0].kdratio, metrics[1].kdratio,
                     metrics[2].kdratio, metrics[3].kdratio);

  if (metrics[i].kdratio > 0.0f) {
    metrics[i].awards |= AWARD_MOSTDEADLY;
  }

  i = mpFindMinFloat(playercount, metrics[0].kdratio, metrics[1].kdratio,
                     metrics[2].kdratio, metrics[3].kdratio);
  ...
  i = mpFindMinInt(playercount, metrics[0].drawplayercount,
                   metrics[1].drawplayercount, metrics[2].drawplayercount,
                   metrics[3].drawplayercount);

  if (PLAYERCOUNT() >= 2) {
    metrics[i].awards |= AWARD_MOSTCOWARDLY;
  }

  i = mpFindMaxFloat(playercount, metrics[0].avgkmperhour,
                     metrics[1].avgkmperhour, metrics[2].avgkmperhour,
                     metrics[3].avgkmperhour);

  if (metrics[i].avgkmperhour > 10.0f) {
    metrics[i].awards |= AWARD_MOSTFRANTIC;
  }

  i = mpFindMinInt(playercount, metrics[0].backshotcount,
                   metrics[1].backshotcount, metrics[2].backshotcount,
                   metrics[3].backshotcount);
  metrics[i].awards |= AWARD_MOSTHONORABLE;

  i = mpFindMaxInt(playercount, metrics[0].backshotcount,
                   metrics[1].backshotcount, metrics[2].backshotcount,
                   metrics[3].backshotcount);

  if (metrics[i].backshotcount > 0 &&
      (metrics[i].awards & AWARD_MOSTHONORABLE) == 0) {
    metrics[i].awards |= AWARD_MOSTDISHONORABLE;
  }

  i = mpFindMaxInt(playercount, metrics[0].longestlife, metrics[1].longestlife,
                   metrics[2].longestlife, metrics[3].longestlife);

  if (metrics[i].longestlife > 0) {
    metrics[i].awards |= AWARD_LONGESTLIFE;
  }

  i = mpFindMinInt(playercount, metrics[0].shortestlife,
                   metrics[1].shortestlife, metrics[2].shortestlife,
                   metrics[3].shortestlife);
  ...
  for (i = 0; i < playercount; i++) {
    ...
    if (playercount == 1) {
      ...
      metrics[i].awards &= 0 | AWARD_MARKSMANSHIP | AWARD_MOSTPROFESSIONAL |
                           AWARD_MOSTDEADLY | AWARD_MOSTFRANTIC |
                           AWARD_MOSTHONORABLE | AWARD_DOUBLEKILL |
                           AWARD_TRIPLEKILL | AWARD_QUADKILL;
    }
  ...
  if (numchrs >= 2) {
    ...
    if (!g_CheatsActiveBank0 && !g_CheatsActiveBank1) {
      if (mostkillsplayer < 4 && mostkillsplayer >= 0) {
        struct mpplayerconfig *mpplayer =
            (struct mpplayerconfig *)MPCHR(mostkillsplayer);
      ...
      if (leastdeathsplayer < 4 && leastdeathsplayer >= 0) {
        struct mpplayerconfig *mpplayer =
            (struct mpplayerconfig *)MPCHR(leastdeathsplayer);
  ...
  if (!g_CheatsActiveBank0 && !g_CheatsActiveBank1 && playercount >= 2) {
    ...
    if (mostheadshotplayer >= 0) {
      struct mpplayerconfig *mpplayer =
          (struct mpplayerconfig *)mpGetChrConfigBySlotNum(mostheadshotplayer);
    ...
    if (mostaccurateplayer >= 0) {
      struct mpplayerconfig *mpplayer =
          (struct mpplayerconfig *)mpGetChrConfigBySlotNum(mostaccurateplayer);
  ...
  for (i = 0; i < playercount; i++) {
    struct mpplayerconfig *mpchr =
        (struct mpplayerconfig *)mpGetChrConfigBySlotNum(i);
...
s32 mpGetNumHeads2(void) { return g_NumMpHeads; }

s32 mpGetNumHeads(void) { return g_NumMpHeads; }

s32 mpGetHeadId(u8 headnum) { return g_MpHeads[headnum].headnum; }

s32 mpGetHeadRequiredFeature(u8 headnum) {
  return g_MpHeads[headnum].requirefeature;
}

s32 mpGetBeauHeadId(u8 headnum) { return g_MpBeauHeads[headnum].headnum; }

s32 mpGetNumBeauHeads(void) { return ARRAYCOUNT(g_MpBeauHeads); }

u32 mpGetNumBodies(void) { return g_NumMpBodies; }
...
s32 mpGetLockType(void) { return g_BossFile.locktype; }

u32 mpGetLockPlayerNum(void) { return g_MpLockInfo.lockedplayernum; }
...
void mpCalculateLockIfLastWinnerOrLoser(void) {
  if (g_BossFile.locktype == MPLOCKTYPE_LASTWINNER &&
      g_MpLockInfo.lastwinner >= 0) {
    g_MpLockInfo.lockedplayernum = g_MpLockInfo.lastwinner;
  }

  if (g_BossFile.locktype == MPLOCKTYPE_LASTLOSER &&
      g_MpLockInfo.lastloser >= 0) {
...
struct mptrack g_MpTracks[] = {
    ...
    /*0x06*/ {MUSIC_CI, 120, L_MISC_130, -1}, // "Carrington Institute"
                                              /*0x07*/
    {MUSIC_DEFECTION, 120, L_MISC_131,
     SOLOSTAGEINDEX_DEFECTION}, // "dD Central"
                                /*0x08*/
    {MUSIC_DEFECTION_X, 120, L_MISC_132,
     SOLOSTAGEINDEX_DEFECTION}, // "dD Central X"
                                /*0x09*/
    {MUSIC_INVESTIGATION, 120, L_MISC_133,
     SOLOSTAGEINDEX_INVESTIGATION}, // "dD Research"
                                    /*0x0a*/
    {MUSIC_INVESTIGATION_X, 120, L_MISC_134,
     SOLOSTAGEINDEX_INVESTIGATION}, // "dD Research X"
                                    /*0x0b*/
    {MUSIC_EXTRACTION, 120, L_MISC_135,
     SOLOSTAGEINDEX_EXTRACTION}, // "dD Extraction"
                                 /*0x0c*/
    {MUSIC_EXTRACTION_X, 120, L_MISC_136,
     SOLOSTAGEINDEX_EXTRACTION},                            // "dD Extraction X"
                                                            /*0x0d*/
    {MUSIC_VILLA, 120, L_MISC_137, SOLOSTAGEINDEX_VILLA},   // "Carrington
                                                            // Villa"
                                                            /*0x0e*/
    {MUSIC_VILLA_X, 120, L_MISC_138, SOLOSTAGEINDEX_VILLA}, // "Carrington
                                                            // Villa X"
    /*0x0f*/
    {MUSIC_CHICAGO, 120, L_MISC_139, SOLOSTAGEINDEX_CHICAGO},   // "Chicago"
                                                                /*0x10*/
    {MUSIC_CHICAGO_X, 120, L_MISC_140, SOLOSTAGEINDEX_CHICAGO}, // "Chicago
                                                                // X"
    /*0x11*/
    {MUSIC_G5, 120, L_MISC_141, SOLOSTAGEINDEX_G5BUILDING},   // "G5 Building"
                                                              /*0x12*/
    {MUSIC_G5_X, 120, L_MISC_142, SOLOSTAGEINDEX_G5BUILDING}, // "G5
                                                              // Building
                                                              // X"
    /*0x13*/
    {MUSIC_INFILTRATION, 120, L_MISC_143,
     SOLOSTAGEINDEX_INFILTRATION}, // "A51 Infiltration"
                                   /*0x14*/
    {MUSIC_INFILTRATION_X, 120, L_MISC_144,
     SOLOSTAGEINDEX_INFILTRATION}, // "A51 Infiltration X"
    /*0x15*/ {MUSIC_RESCUE, 120, L_MISC_145, SOLOSTAGEINDEX_RESCUE}, // "A51
                                                                     // Rescue"
    /*0x16*/ {MUSIC_RESCUE_X, 120, L_MISC_146, SOLOSTAGEINDEX_RESCUE}, // "A51
                                                                       // Rescue
                                                                       // X"
    /*0x17*/ {MUSIC_ESCAPE, 120, L_MISC_147, SOLOSTAGEINDEX_ESCAPE},   // "A51
                                                                     // Escape"
    /*0x18*/ {MUSIC_ESCAPE_X, 120, L_MISC_148, SOLOSTAGEINDEX_ESCAPE}, // "A51
                                                                       // Escape
                                                                       // X"
    /*0x19*/ {MUSIC_AIRBASE, 120, L_MISC_149, SOLOSTAGEINDEX_AIRBASE}, // "Air
                                                                       // Base"
    /*0x1a*/ {MUSIC_AIRBASE_X, 120, L_MISC_150, SOLOSTAGEINDEX_AIRBASE}, // "Air
                                                                         // Base
                                                                         // X"
    /*0x1b*/
    {MUSIC_AIRFORCEONE, 120, L_MISC_151,
     SOLOSTAGEINDEX_AIRFORCEONE}, // "Air Force One"
                                  /*0x1c*/
    {MUSIC_AIRFORCEONE_X, 120, L_MISC_152,
     SOLOSTAGEINDEX_AIRFORCEONE}, // "Air Force One X"
                                  /*0x1d*/
    {MUSIC_CRASHSITE, 120, L_MISC_153,
     SOLOSTAGEINDEX_CRASHSITE}, // "Crash Site"
                                /*0x1e*/
    {MUSIC_CRASHSITE_X, 120, L_MISC_154,
     SOLOSTAGEINDEX_CRASHSITE},                               // "Crash Site X"
                                                              /*0x1f*/
    {MUSIC_PELAGIC, 120, L_MISC_155, SOLOSTAGEINDEX_PELAGIC}, // "Pelagic
                                                              // II"
                                                              /*0x20*/
    {MUSIC_PELAGIC_X, 120, L_MISC_156, SOLOSTAGEINDEX_PELAGIC}, // "Pelagic
                                                                // II
                                                                // X"
    /*0x21*/ {MUSIC_DEEPSEA, 120, L_MISC_157, SOLOSTAGEINDEX_DEEPSEA}, // "Deep
                                                                       // Sea"
                                                                       /*0x22*/
    {MUSIC_DEEPSEA_X, 120, L_MISC_158, SOLOSTAGEINDEX_DEEPSEA},        // "Deep
                                                                       // Sea
                                                                       // X"
    /*0x23*/
    {MUSIC_DEFENSE, 120, L_MISC_159,
     SOLOSTAGEINDEX_DEFENSE}, // "Institute Defense"
                              /*0x24*/
    {MUSIC_DEFENSE_X, 120, L_MISC_160, SOLOSTAGEINDEX_DEFENSE}, // "Institute
                                                                // Defense
                                                                // X"
    /*0x25*/
    {MUSIC_ATTACKSHIP, 120, L_MISC_161,
     SOLOSTAGEINDEX_ATTACKSHIP}, // "Attack Ship"
                                 /*0x26*/
    {MUSIC_ATTACKSHIP_X, 120, L_MISC_162,
     SOLOSTAGEINDEX_ATTACKSHIP}, // "Attack Ship X"
                                 /*0x27*/
    {MUSIC_SKEDARRUINS, 120, L_MISC_163,
     SOLOSTAGEINDEX_SKEDARRUINS}, // "Skedar Ruins"
                                  /*0x28*/
    {MUSIC_SKEDARRUINS_X, 120, L_MISC_164,
     SOLOSTAGEINDEX_SKEDARRUINS}, // "Skedar Ruins X"
                                  /*0x29*/
    {MUSIC_CREDITS, 120, L_MISC_165,
     SOLOSTAGEINDEX_SKEDARRUINS}, // "End Credits"
#if VERSION < VERSION_PAL_BETA
    /*0x2a*/
    {MUSIC_SKEDARRUINS_KING, 120, L_MISC_261,
     SOLOSTAGEINDEX_SKEDARRUINS}, // "Skedar Warrior" (Skedar Leader)
#else
    /*0x2a*/
    {MUSIC_SKEDARRUINS_KING, 120, L_MISC_041,
     SOLOSTAGEINDEX_SKEDARRUINS}, // "E R R O R" (can't find a good
                                  // approximation for Skedar Leader)
#endif
};
...
bool mpGetUsingMultipleTunes(void) { return g_BossFile.usingmultipletunes; }
...
void mpSetTrackToRandom(void) { g_BossFile.tracknum = -1; }
...
void mpCreateBotFromProfile(s32 botnum, u8 profilenum) {
  ...
  for (i = 0; i < MAX_PLAYERS; i++) {
    g_MpSimulantDifficultiesPerNumPlayers[botnum][i] =
...
void mpCopySimulant(s32 index) {
  ...
  g_BotConfigsArray[dest].base.mpheadnum =
      g_BotConfigsArray[index].base.mpheadnum;
  g_BotConfigsArray[dest].base.mpbodynum =
      g_BotConfigsArray[index].base.mpbodynum;
...
void mpGenerateBotNames(void) {
  ...
  for (i = 4; i < MAX_MPCHRS; i++) {
    if (g_MpSetup.chrslots & (1 << i)) {
      profilenum = mpFindBotProfile(g_BotConfigsArray[i - 4].type,
                                    g_BotConfigsArray[i - 4].difficulty);
...
#if VERSION >= VERSION_NTSC_1_0
const char var7f1b8b80[] =
    "Adding GBCHead to load to slot %d: guid is %x-%x, player is %d\n";
...
void mpplayerfileLoadGunFuncs(struct savebuffer *buffer, s32 playernum) {
  ...
  while (bitsremaining > 0) {
    ...
    g_PlayerConfigsArray[playernum].gunfuncs[i] =
        savebufferReadBits(buffer, numbits);
...
void mpplayerfileLoadWad(s32 playernum, struct savebuffer *buffer, s32 arg2) {
    ...
    if (g_PlayerConfigsArray[playernum].base.mpheadnum >= mpGetNumHeads2()) {
      if (guid.fileid != 0 && guid.deviceserial != 0) {
        if (g_MenuData.unk668 < 11) {
          ...
          g_MenuData.unk5d8[g_MenuData.unk668].fileguid.deviceserial =
              guid.deviceserial;
  ...
  g_PlayerConfigsArray[playernum].accuracymedals =
      savebufferReadBits(buffer, 18);
  g_PlayerConfigsArray[playernum].headshotmedals =
      savebufferReadBits(buffer, 18);
  g_PlayerConfigsArray[playernum].killmastermedals =
      savebufferReadBits(buffer, 18);
  g_PlayerConfigsArray[playernum].survivormedals =
      savebufferReadBits(buffer, 16);
  ...
  for (i = 0; i < ARRAYCOUNT(g_MpChallenges); i++) {
    for (j = 1; j < MAX_PLAYERS + 1; j++) {
      challengeSetCompletedByPlayerWithNumPlayers(
          playernum, i, j, savebufferReadBits(buffer, 1));
    }
  }
...
void mpplayerfileSaveWad(s32 playernum, struct savebuffer *buffer) {
  ...
  if (g_PlayerConfigsArray[playernum].base.mpheadnum >= mpGetNumHeads2()) {
    struct fileguid guid;
    phGetGuid(g_PlayerConfigsArray[playernum].base.mpheadnum - mpGetNumHeads2(),
              &guid);
  ...
  savebufferOr(buffer,
               ((controlmode == CONTROLMODE_PC) ? CONTROLMODE_11 : controlmode),
               2);
#endif
  ...
  for (i = 0; i < ARRAYCOUNT(g_MpChallenges); i++) {
    for (j = 1; j < MAX_PLAYERS + 1; j++) {
      savebufferOr(buffer,
                   challengeIsCompletedByPlayerWithNumPlayers(playernum, i, j),
                   1);
    }
  }
...
static inline void mpplayerBindExtendedProfile(s32 playernum) {
  ...
  if (configindex > 0) {
    ...
    configindex = iniBindProfileProperties(
        &g_PlayerConfigsArray[playernum].fileguid, 0, -1);
    g_PlayerConfigsArray[playernum].configindex = configindex;

  } else {
    // register new entry
    // need table with cfgtype, slugname, defaultvalue for every extended
    // profile property so the appriate init function can be called and config
    // file setup
    configindex = iniBindProfileProperties(
...
s32 mpplayerfileSave(s32 playernum, s32 device, s32 fileid, u16 deviceserial) {
  ...
  if (device >= 0) {
    ...
    ret = pakSaveAtGuid(device, fileid, PAKFILETYPE_MPPLAYER, buffer.bytes,
                        &newfileid, 0);
...
s32 mpGetNumPresets(void) { return ARRAYCOUNT(g_MpPresets); }
...
bool mpIsPresetUnlocked(s32 presetnum) {
  ...
  for (i = 0; i < ARRAYCOUNT(g_MpPresets[presetnum].requirefeatures); i++) {
    if (!challengeIsFeatureUnlocked(
            g_MpPresets[presetnum].requirefeatures[i]) &&
...
const char var7f1b8d38[] =
    "GBCHead: Call to create head for slot %d (gbcheadobjs[slotno]=%x)\n";
...
void mpApplyConfig(struct mpconfigfull *config) {
  ...
  for (i = 0; i < MAX_BOTS; i++) {
    ...
    for (j = 0; j < MAX_PLAYERS; j++) {
      g_MpSimulantDifficultiesPerNumPlayers[i][j] =
          config->config.simulants[i].difficulties[j];
    }

    g_BotConfigsArray[i].difficulty =
        g_MpSimulantDifficultiesPerNumPlayers[i][0];
...
void mpsetupfileLoadWad(struct savebuffer *buffer, u8 version) {
  ...
  if (version > 0) {
    savebufferReadString_ext(buffer, g_MpSetup.name, false,
                             MPSETUP_MAXNAME + 1);
  } else {
...
void mpsetupfileSaveWad(struct savebuffer *buffer) {
  ...
  for (i = 0; i < MAX_BOTS; i++) {
    ...
    if (g_BotConfigsArray[i].base.mpbodynum == 0xff) {
      s32 profilenum = mpFindBotProfile(g_BotConfigsArray[i].type,
                                        g_BotConfigsArray[i].difficulty);
