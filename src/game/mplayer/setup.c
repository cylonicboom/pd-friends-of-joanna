...
MenuItemHandlerResult menuhandlerMpDropOut(s32 operation, struct menuitem *item,
...
MenuItemHandlerResult menuhandlerMpTeamsLabel(s32 operation,
...
struct menudialogdef g_MpDropOutMenuDialog = {
    ...
    g_MpDropOutMenuItems,  NULL, 0, NULL,
};
...
MenuItemHandlerResult mpArenaMenuHandler(s32 operation, struct menuitem *item,
                                         union handlerdata *data) {
  ...
  case MENUOP_GETOPTGROUPTEXT:
    ...
    if (g_MpArenas == g_MpArenas_Vanilla) {
      if (!challengeIsFeatureUnlocked(MPFEATURE_STAGE_COMPLEX) &&
          !challengeIsFeatureUnlocked(MPFEATURE_STAGE_TEMPLE) &&
          !challengeIsFeatureUnlocked(MPFEATURE_STAGE_FELICITY) && count > 0) {
        count++;
      }
    }
...
MenuItemHandlerResult menuhandlerMpControlStyle(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  u16 labels[] = {
      L_OPTIONS_239, // "1.1"
  ...
  case MENUOP_GETOPTIONCOUNT:
    ...
    break;
  case MENUOP_GETOPTIONTEXT:
    return (intptr_t)((data->dropdown.value == 4)
                          ? "Ext"
                          : langGet(labels[data->dropdown.value]));
  case MENUOP_SET:
    optionsSetControlMode(
        g_MpPlayerNum,
        (data->dropdown.value == 4 ? CONTROLMODE_PC : data->dropdown.value));
#ifndef PLATFORM_N64
...
MenuItemHandlerResult menuhandlerMpWeaponSlot(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
...
MenuItemHandlerResult menuhandlerMpWeaponSetDropdown(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
...
MenuItemHandlerResult menuhandlerMpClassicSight(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  if (g_PlayerConfigsArray[g_MpPlayerNum].classicsight == NULL) {
    iniRegisterPlayerSave(&g_PlayerConfigsArray[g_MpPlayerNum].fileguid, 1,
                          g_MpPlayerNum);
  }
...
MenuItemHandlerResult menuhandlerMpShowLives(s32 operation,
                                             struct menuitem *item,
                                             union handlerdata *data) {
...
MenuItemHandlerResult menuhandlerMpControlCheckbox(s32 operation,
                                                   struct menuitem *item,
                                                   union handlerdata *data) {
  s32 val;
...
MenuItemHandlerResult menuhandlerMpAimControl(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  u16 labels[] = {
...
MenuItemHandlerResult menuhandlerMpCheckboxOption(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  switch (operation) {
  case MENUOP_GET:
...
MenuItemHandlerResult menuhandlerMpTeamsEnabled(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  if (operation == MENUOP_CHECKDISABLED) {
...
menuhandlerMpDisplayOptionCheckbox(s32 operation, struct menuitem *item,
                                   union handlerdata *data) {
  switch (operation) {
  case MENUOP_GET:
    if ((g_PlayerConfigsArray[g_MpPlayerNum].base.displayoptions &
         item->param3) == 0) {
      return false;
    }
    return true;
  case MENUOP_SET:
    g_PlayerConfigsArray[g_MpPlayerNum].base.displayoptions &=
        ~(u8)item->param3;
...
MenuItemHandlerResult
menuhandlerMpSetupInGameSubtitles(s32 operation, struct menuitem *item,
                                  union handlerdata *data) {
...
MenuItemHandlerResult
menuhandlerMpSetupCutsceneSubtitles(s32 operation, struct menuitem *item,
                                    union handlerdata *data) {
...
MenuItemHandlerResult
menuhandlerMpSetupShowMissionTime(s32 operation, struct menuitem *item,
                                  union handlerdata *data) {
...
MenuItemHandlerResult
menuhandlerMpSetupShowPlayerName(s32 operation, struct menuitem *item,
                                 union handlerdata *data) {
...
MenuItemHandlerResult menuhandlerMpConfirmSaveChr(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  if (operation == MENUOP_SET) {
    menuPopDialog();
...
MenuItemHandlerResult menuhandlerMpSetupName(s32 operation,
                                             struct menuitem *item,
                                             union handlerdata *data) {
...
MenuItemHandlerResult menuhandlerMpSaveSetupOverwrite(s32 operation,
                                                      struct menuitem *item,
                                                      union handlerdata *data) {
  if (operation == MENUOP_SET) {
    menuPopDialog();
...
MenuItemHandlerResult menuhandlerMpSaveSetupCopy(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
  if (operation == MENUOP_SET) {
    menuPopDialog();
...
char *mpMenuTextSetupName(struct menuitem *item) { return g_MpSetup.name; }
#endif

MenuItemHandlerResult func0f179b68(s32 operation, struct menuitem *item,
                                   union handlerdata *data) {
  switch (operation) {
...
MenuItemHandlerResult func0f179c14(s32 operation, struct menuitem *item,
                                   union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETSLIDER:
...
MenuItemHandlerResult func0f179cc0(s32 operation, struct menuitem *item,
                                   union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETSLIDER:
...
MenuItemHandlerResult func0f179d6c(s32 operation, struct menuitem *item,
                                   union handlerdata *data) {
  if (operation == MENUOP_SET) {
 ...
 */
MenuItemHandlerResult mpCharacterBodyMenuHandler(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data,
                                                 s32 mpbodynum, s32 mpheadnum,
                                                 bool isplayer) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
  ...
  case MENUOP_11:
    ...
    g_Menus[g_MpPlayerNum].menumodel.newparams =
        MENUMODELPARAMS_SET_MP_HEADBODY(mpheadnum, mpbodynum);
    ...
    if (g_Menus[g_MpPlayerNum].menumodel.rottimer60 > 0) {
      ...
      f32 value = g_Menus[g_MpPlayerNum].menumodel.curroty +
                  0.01f * g_Vars.diffframe60freal;
#else
      f32 value = g_Menus[g_MpPlayerNum].menumodel.curroty +
                  0.01f * g_Vars.diffframe60f;
#endif
  ...
  case MENUOP_21:
    if (!challengeIsFeatureUnlocked(
            mpGetBodyRequiredFeature(data->carousel.value))) {
      return 1;
    }
    break;
#if VERSION >= VERSION_NTSC_1_0
...
MenuItemHandlerResult menuhandlerMpCharacterBody(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
  switch (operation) {
  case MENUOP_SET:
    if (g_PlayerConfigsArray[g_MpPlayerNum].base.mpheadnum < mpGetNumHeads()) {
...
#endif
      {
        g_PlayerConfigsArray[g_MpPlayerNum].base.mpheadnum =
            mpGetMpheadnumByMpbodynum(data->carousel.value);
      }
    }
  ...
  return mpCharacterBodyMenuHandler(
      operation, item, data, g_PlayerConfigsArray[g_MpPlayerNum].base.mpbodynum,
      g_PlayerConfigsArray[g_MpPlayerNum].base.mpheadnum, true);
}

MenuDialogHandlerResult menudialog0017a174(s32 operation,
...
MenuItemHandlerResult mpChallengesListHandler(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  Gfx *gdl;
  ...
  case MENUOP_RENDER:
    ...
    gdl = textRenderProjected(gdl, &x, &y, name, g_CharsHandelGothicSm,
                              g_FontHandelGothicSm, renderdata->colour,
    ...
    for (i = 0, loopx = 10; i < maxplayers; i++) {
#if VERSION >= VERSION_NTSC_1_0
      if (challengeIsCompletedByPlayerWithNumPlayers2(g_MpPlayerNum,
                                                      challengeindex, i + 1)) {
        gDPSetEnvColorViaWord(gdl++, 0xb2efff00 | (renderdata->colour & 0xff) *
                                                      255 / 256);
      } else {
        gDPSetEnvColorViaWord(gdl++, 0x30407000 | (renderdata->colour & 0xff) *
                                                      255 / 256);
      }
#else
      if (challengeIsCompletedByPlayerWithNumPlayers2(g_MpPlayerNum,
      ...
      gSPTextureRectangle(gdl++, ((renderdata->x + loopx) << 2) * g_ScaleX,
                          (renderdata->y + size) << 2,
                          ((renderdata->x + size + loopx) << 2) * g_ScaleX,
                          (renderdata->y + size * 2) << 2, G_TX_RENDERTILE, 0,
                          0x0160, 0x0400 / g_ScaleX, 0xfc00);
...
char *mpMenuTextAccuracy(struct menuitem *item) {
  ...
  sprintf(g_StringPointer, "%s%s%.1f%%", "", "",
          g_PlayerConfigsArray[g_MpPlayerNum].accuracy / 10.0f);
  return g_StringPointer;
}
...
char *mpMenuTextPainReceived(struct menuitem *item) {
  mpFormatDamageValue(g_StringPointer,
                      g_PlayerConfigsArray[g_MpPlayerNum].painreceived / 10.0f);
  return g_StringPointer;
}

char *mpMenuTextDamageDealt(struct menuitem *item) {
  mpFormatDamageValue(g_StringPointer,
                      g_PlayerConfigsArray[g_MpPlayerNum].damagedealt / 10.0f);
  return g_StringPointer;
}

MenuItemHandlerResult mpMedalMenuHandler(s32 operation, struct menuitem *item,
                                         union handlerdata *data) {
  if (operation == MENUOP_RENDER) {
    ...
    colour = (colour & 0xffffff00) |
             (colour & 0xff) * (renderdata->colour & 0xff) >> 8;
#endif

    gDPSetEnvColorViaWord(gdl++, colour);

    gDPSetCombineLERP(gdl++, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, ENVIRONMENT,
                      0, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, ENVIRONMENT, 0);

    gSPTextureRectangle(
        gdl++, ((renderdata->x + 9) << 2) * g_ScaleX, renderdata->y << 2,
...
char *mpMenuTitleStatsForPlayerName(struct menudialogdef *dialogdef) {
  // "Stats for %s"
  sprintf(g_StringPointer, langGet(L_MPMENU_145),
          g_PlayerConfigsArray[g_MpPlayerNum].base.name);
  return g_StringPointer;
}

MenuItemHandlerResult menuhandlerMpUsernamePassword(s32 operation,
                                                    struct menuitem *item,
                                                    union handlerdata *data) {
...
#ifndef PLATFORM_N64
MenuItemHandlerResult mpSelectRandomWeaponListHandler(s32 operation,
                                                      struct menuitem *item,
                                                      union handlerdata *data) {
  ...
  case MENUOP_SET: {
    ...
    if (data->list.value < numweapons) {
      if (data->list.unk04 == 0) {
        ...
        g_MpWeaponSetRandomFilters[optionindex] =
            1 - g_MpWeaponSetRandomFilters[optionindex];
      }
    } else {
      ...
      case 0:
        ...
        for (i = 0; i < ARRAYCOUNT(g_MpWeapons); i++) {
          if ((i >= MPWEAPON_NONE && i <= MPWEAPON_XRAYSCANNER) ||
              i == MPWEAPON_CLOAKINGDEVICE || i == MPWEAPON_COMBATBOOST ||
              i >= MPWEAPON_SHIELD) {
...
struct menudialogdef g_MpSelectRandomWeaponsMenuDialog = {
    MENUDIALOGTYPE_DEFAULT,           (uintptr_t)"Select Weapons",
    g_MpSelectRandomWeaponsMenuItems, NULL,
    MENUDIALOGFLAG_LITERAL_TEXT,      NULL,
};

MenuItemHandlerResult
menuhandlerMpSelectRandomWeapons(s32 operation, struct menuitem *item,
                                 union handlerdata *data) {
  switch (operation) {
...
MenuItemHandlerResult menuhandlerMpAutoRandomWeapon(s32 operation,
                                                    struct menuitem *item,
                                                    union handlerdata *data) {
  static const char *labels[] = {
      "Off",
  ...
  case MENUOP_SET:
    g_MpSetup.options &=
        ~(MPOPTION_AUTORANDOMWEAPON_START | MPOPTION_AUTORANDOMWEAPON_END);
...
struct menuitem g_MpWeaponsMenuItems[] = {
    {
        ...
        1,
        MENUITEMFLAG_LESSLEFTPADDING | MENUITEMFLAG_DROPDOWN_BELOW |
            MENUITEMFLAG_LOCKABLEMINOR,
        L_MPMENU_174, // "Set:"
        0,
...
struct menudialogdef g_MpWeaponsMenuDialog = {
    ...
    g_MpWeaponsMenuItems,   NULL, MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
struct menudialogdef g_MpControlMenuDialog = {
    ...
    g_MpControlMenuItems,   NULL, 0, NULL,
};
...
char *mpMenuTextUsernamePassword(struct menuitem *item) {
  ...
  u8 username[] = {
      'E' + 9 * 1,  'n' + 9 * 2,  'T' + 9 * 3,  'R' + 9 * 4,   'O' + 9 * 5,
      'p' + 9 * 6,  'I' + 9 * 7,  'c' + 9 * 8,  'D' + 9 * 9,   'e' + 9 * 10,
      'C' + 9 * 11, 'A' + 9 * 12, 'y' + 9 * 13, '\n' + 9 * 14, '\0' + 9 * 15,
  };

  u8 password[] = {
      'Z' + 4 * 1, 'e' + 4 * 2, 'R' + 4 * 3, 'o' + 4 * 4,  '-' + 4 * 5,
      'T' + 4 * 6, 'a' + 4 * 7, 'u' + 4 * 8, '\n' + 4 * 9, '\0' + 4 * 10,
  };
...
MenuItemHandlerResult mpCharacterHeadMenuHandler(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data,
                                                 s32 mpheadnum, bool arg4) {
  f32 diffframe;
  s32 headnum;
  ...
  case MENUOP_11:
    ...
    if (mpheadnum < mpGetNumHeads2()) {
      ...
      g_Menus[g_MpPlayerNum].menumodel.perfectheadnum =
          mpheadnum - mpGetNumHeads2();
    }
  ...
  case MENUOP_21:
    if (!challengeIsFeatureUnlocked(
            mpGetHeadRequiredFeature(data->carousel.value))) {
      return 1;
    }
    break;
  case MENUOP_GETSELECTEDINDEX:
...
MenuItemHandlerResult menuhandlerMpCharacterHead(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
  if (operation == MENUOP_SET) {
  ...
  return mpCharacterHeadMenuHandler(
      operation, item, data, g_PlayerConfigsArray[g_MpPlayerNum].base.mpheadnum,
      1);
}
...
char *mpMenuTextBodyName(struct menuitem *item) {
  ...
  s32 bodyIdx =
      (mpbodynum < g_NumMpBodies) ? g_MpBodies[mpbodynum].bodynum : -1;
...
char *mpMenuTextHeadIndex(struct menuitem *item) {
  ...
  s32 headIdx = (mpheadnum >= 0 && mpheadnum < g_NumMpHeads)
                    ? g_MpHeads[mpheadnum].headnum
                    : -1;
...
void func0f17b8f0(void) { func0f0f139c(g_MpCharacterMenuItems, -0.4f); }

MenuItemHandlerResult mpPlayerNameMenuHandler(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  char *name = data->keyboard.string;
  s32 i;
  ...
  case MENUOP_GETTEXT:
    ...
    while (g_PlayerConfigsArray[g_MpPlayerNum].base.name[i] != '\n' &&
           g_PlayerConfigsArray[g_MpPlayerNum].base.name[i] != '\0' && i < 11) {
...
MenuItemHandlerResult mpLoadSettingsMenuHandler(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  ...
  case MENUOP_GETOPTIONTEXT:
    ...
    if (g_MpSetupFile.numsetups > 0) {
      struct setupblock *block =
          &g_MpSetupFile.setups[data->list.value - numpresets];
      func0f0d564c_ext(block->bytes, g_StringPointer, false,
                       MPSETUP_MAXNAME + 1);
  ...
  case MENUOP_SET:
    ...
    if (item->param == 1) {
      if (IS4MB()) {
        menuSaveAndRecordPrevMenuRoot(&g_MpQuickGo4MbMenuDialog,
...
char *mpMenuTextMpconfigMarquee(struct menuitem *item) {
  ...
  if (g_Menus[g_MpPlayerNum].mpsetup.slotindex < 0xffff &&
      g_MpSetupFile.numsetups > 0) {
#if VERSION >= VERSION_NTSC_1_0
    arenanum = -1;
#else
    arenanum = 0;
    ...
    mpsetupfileGetOverview(
        g_MpSetupFile.setups[g_Menus[g_MpPlayerNum].mpsetup.slotindex].bytes,
...
#if VERSION >= VERSION_NTSC_1_0
    if (scenarionum <= 5 && arenanum != -1 && numsims >= 0 &&
        filename[0] != '\0' && numsims <= MAX_BOTS) {
      ...
      sprintf(g_StringPointer, langGet(L_MPMENU_140), filename,
              langGet(g_MpScenarioOverviews[scenarionum].name), arenaName,
              numsims);
    } else {
      return "";
    }
...
intptr_t mpLoadPlayerMenu(s32 operation, struct menuitem *item,
                          union handlerdata *data, u32 playernum) {
  s32 i;
  ...
  case MENUOP_GETOPTIONTEXT:
    filemgrGetSelectName(g_StringPointer,
                         &g_FileLists[0]->files[data->list.value],
                         FILETYPE_MPPLAYER);
    return (uintptr_t)g_StringPointer;
  case MENUOP_SET:
  ...
  case MENUOP_GETGROUPSTARTINDEX:
    data->list.groupstartindex =
        filemgrGetDeviceNameOrStartIndex(0, operation, data->list.value);
    return 0;
  }
...
MenuItemHandlerResult mpLoadPlayerMenuHandler(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  return mpLoadPlayerMenu(operation, item, data, g_MpPlayerNum);
}

MenuItemHandlerResult mpLoadPlayer1MenuHandler(s32 operation,
                                               struct menuitem *item,
                                               union handlerdata *data) {
  return mpLoadPlayerMenu(operation, item, data, 0);
}

MenuItemHandlerResult mpLoadPlayer2MenuHandler(s32 operation,
                                               struct menuitem *item,
                                               union handlerdata *data) {
  return mpLoadPlayerMenu(operation, item, data, 1);
}

MenuItemHandlerResult mpLoadPlayer3MenuHandler(s32 operation,
                                               struct menuitem *item,
                                               union handlerdata *data) {
  return mpLoadPlayerMenu(operation, item, data, 2);
}

MenuItemHandlerResult mpLoadPlayer4MenuHandler(s32 operation,
                                               struct menuitem *item,
                                               union handlerdata *data) {
  return mpLoadPlayerMenu(operation, item, data, 3);
}

MenuItemHandlerResult menuhandlerMpTimeLimitSlider(s32 operation,
                                                   struct menuitem *item,
                                                   union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETSLIDER:
  ...
  case MENUOP_GETSLIDERLABEL:
    if (data->slider.value == 60) {
      ...
      sprintf(data->slider.label, langGet(L_MPMENU_114),
...
MenuItemHandlerResult menuhandlerMpScoreLimitSlider(s32 operation,
                                                    struct menuitem *item,
                                                    union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETSLIDER:
  ...
  case MENUOP_GETSLIDERLABEL:
    if (data->slider.value == 100) {
      ...
      sprintf(data->slider.label, langGet(L_MPMENU_113),
...
MenuItemHandlerResult
menuhandlerMpTeamScoreLimitSlider(s32 operation, struct menuitem *item,
                                  union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETSLIDER:
...
MenuItemHandlerResult
menuhandlerMpRestoreScoreDefaults(s32 operation, struct menuitem *item,
                                  union handlerdata *data) {
  if (operation == MENUOP_SET) {
    func0f187fec();
  }
...
MenuItemHandlerResult menuhandlerHandicapPlayer(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data,
                                                s32 playernum) {
  switch (operation) {
  ...
  case MENUOP_GETSLIDERLABEL:
    sprintf(data->slider.label, "%s%s%.00f%%\n", "", "",
            mpHandicapToDamageScale(*g_PlayerConfigsArray[playernum].handicap) *
                100);
    break;
  }
...
MenuItemHandlerResult menuhandlerMpHandicapPlayer(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  return menuhandlerHandicapPlayer(operation, item, data, item->param);
}

MenuItemHandlerResult menuhandlerTeamHandicapPlayer1(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  return menuhandlerHandicapPlayer(operation, item, data, 0);
}

MenuItemHandlerResult menuhandlerTeamHandicapPlayer2(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  return menuhandlerHandicapPlayer(operation, item, data, 1);
}

MenuItemHandlerResult menuhandlerTeamHandicapPlayer3(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  return menuhandlerHandicapPlayer(operation, item, data, 2);
}

MenuItemHandlerResult menuhandlerTeamHandicapPlayer4(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
...
MenuItemHandlerResult
menuhandlerMpRestoreHandicapDefaults(s32 operation, struct menuitem *item,
                                     union handlerdata *data) {
  if (operation == MENUOP_SET) {
    s32 i;

    for (i = 0; i < MAX_PLAYERS; i++) {
      if (g_PlayerConfigsArray[i].handicap)
...
MenuDialogHandlerResult menudialogMpReady(s32 operation,
                                          struct menudialogdef *dialogdef,
                                          union handlerdata *data) {
  if (operation == MENUOP_OPEN) {
    if (g_PlayerConfigsArray[g_MpPlayerNum].fileguid.fileid &&
        g_PlayerConfigsArray[g_MpPlayerNum].fileguid.deviceserial) {
      filemgrSaveOrLoad(&g_PlayerConfigsArray[g_MpPlayerNum].fileguid,
                        FILEOP_SAVE_MPPLAYER, g_MpPlayerNum);
    }
  }
...
MenuDialogHandlerResult menudialogMpSimulant(s32 operation,
                                             struct menudialogdef *dialogdef,
                                             union handlerdata *data) {
  if (operation == MENUOP_TICK) {
    if ((u8)g_BotConfigsArray[g_Menus[g_MpPlayerNum].mpsetup.slotindex]
            .base.name[0] == '\0') {
      menuPopDialog();
    }
  }
...
mpLoadSettingsDialogHandler(s32 operation, struct menudialogdef *dialogdef,
                            union handlerdata *data) {
  if (operation == MENUOP_TICK) {
...
struct menudialogdef g_MpCharacterMenuDialog = {
    ...
    g_MpCharacterMenuItems, menudialog0017a174, MENUDIALOGFLAG_0002, NULL,
};
...
struct menudialogdef g_MpLimitsMenuDialog = {
    MENUDIALOGTYPE_DEFAULT,
    L_MPMENU_107, // "Limits"
    g_MpLimitsMenuItems,    NULL, MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
struct menudialogdef g_MpHandicapsMenuDialog = {
    ...
    g_MpHandicapsMenuItems, NULL, MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
MenuItemHandlerResult mpAddChangeSimulantMenuHandler(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  s32 i;
  s32 count = 0;
...
MenuItemHandlerResult menuhandlerMpSimulantHead(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  s32 start = 0;
  ...
  case MENUOP_SET:
    g_BotConfigsArray[g_Menus[g_MpPlayerNum].mpsetup.slotindex].base.mpheadnum =
        start + data->carousel.value;
  case MENUOP_FOCUS:
    if (operation == MENUOP_FOCUS && item->param2 == 1 &&
        g_BotConfigsArray[g_Menus[g_MpPlayerNum].mpsetup.slotindex]
                .base.mpheadnum < start) {
      g_BotConfigsArray[g_Menus[g_MpPlayerNum].mpsetup.slotindex]
          .base.mpheadnum = start;
    }
    break;
...
MenuItemHandlerResult menuhandlerMpSimulantBody(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
MenuDialogHandlerResult menudialog0017ccfc(s32 operation,
                                           struct menudialogdef *dialogdef,
                                           union handlerdata *data) {
  switch (operation) {
  case MENUOP_TICK:
...
MenuItemHandlerResult mpBotDifficultyMenuHandler(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
  s32 count = 0;
  s32 i;
  ...
  switch (operation) {
  case MENUOP_SET:
    mpSetBotDifficulty(g_Menus[g_MpPlayerNum].mpsetup.slotindex,
                       data->dropdown.value);
    mpGenerateBotNames();
    break;
  case MENUOP_GETSELECTEDINDEX:
    if (g_BotConfigsArray[g_Menus[g_MpPlayerNum].mpsetup.slotindex]
                .difficulty >= 0 &&
...
MenuItemHandlerResult menuhandlerMpDeleteSimulant(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
#ifndef PLATFORM_N64
MenuItemHandlerResult menuhandlerMpCopySimulant(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  switch (operation) {
  case MENUOP_SET:
...
char *mpMenuTitleEditSimulant(struct menudialogdef *dialogdef) {
  sprintf(
      g_StringPointer, "%s",
      &g_BotConfigsArray[g_Menus[g_MpPlayerNum].mpsetup.slotindex].base.name);
  return g_StringPointer;
}

MenuItemHandlerResult menuhandlerMpChangeSimulantType(s32 operation,
                                                      struct menuitem *item,
                                                      union handlerdata *data) {
  if (operation == MENUOP_SET) {
    s32 i;
...
MenuItemHandlerResult menuhandlerMpClearAllSimulants(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  if (operation == MENUOP_SET) {
    s32 i;
...
MenuItemHandlerResult menuhandlerMpAddSimulant(s32 operation,
                                               struct menuitem *item,
                                               union handlerdata *data) {
  switch (operation) {
  case MENUOP_SET:
...
MenuItemHandlerResult menuhandlerMpSimulantSlot(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  switch (operation) {
  case MENUOP_SET:
...
MenuDialogHandlerResult menudialogMpSimulants(s32 operation,
                                              struct menudialogdef *dialogdef,
                                              union handlerdata *data) {
  if (operation == MENUOP_OPEN) {
...
struct menudialogdef g_MpEditSimulantMenuDialog = {
    MENUDIALOGTYPE_DEFAULT,    (uintptr_t)&mpMenuTitleEditSimulant,
    g_MpEditSimulantMenuItems, menudialogMpSimulant,
    MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
MenuItemHandlerResult menuhandlerMpNTeams(s32 operation, struct menuitem *item,
                                          union handlerdata *data,
                                          s32 numteams) {
  if (operation == MENUOP_SET) {
...
MenuItemHandlerResult menuhandlerMpTwoTeams(s32 operation,
                                            struct menuitem *item,
                                            union handlerdata *data) {
  return menuhandlerMpNTeams(operation, item, data, 2);
}

MenuItemHandlerResult menuhandlerMpThreeTeams(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  return menuhandlerMpNTeams(operation, item, data, 3);
}

MenuItemHandlerResult menuhandlerMpFourTeams(s32 operation,
                                             struct menuitem *item,
                                             union handlerdata *data) {
  return menuhandlerMpNTeams(operation, item, data, 4);
}

MenuItemHandlerResult menuhandlerMpMaximumTeams(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  if (operation == MENUOP_SET) {
    s32 i;
...
MenuItemHandlerResult menuhandlerMpHumansVsSimulants(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  if (operation == MENUOP_SET) {
    s32 i;
...
MenuItemHandlerResult menuhandlerMpHumanSimulantPairs(s32 operation,
                                                      struct menuitem *item,
                                                      union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
MenuItemHandlerResult func0f17dac4(s32 operation, struct menuitem *item,
                                   union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
...
MenuItemHandlerResult menuhandlerMpTeamSlot(s32 operation,
                                            struct menuitem *item,
                                            union handlerdata *data) {
...
struct menudialogdef g_MpAutoTeamMenuDialog = {
    ...
    g_MpAutoTeamMenuItems,  NULL, MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
struct menudialogdef g_MpTeamsMenuDialog = {
    ...
    g_MpTeamsMenuItems,     NULL, MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
 ...
 */
MenuItemHandlerResult mpSelectTuneListHandler(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
...
MenuDialogHandlerResult menudialogMpSelectTune(s32 operation,
                                               struct menudialogdef *dialogdef,
                                               union handlerdata *data) {
  if (operation == MENUOP_OPEN) {
...
MenuItemHandlerResult menuhandlerMpMultipleTunes(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
  switch (operation) {
  case MENUOP_GET:
...
MenuItemHandlerResult mpTeamNameMenuHandler(s32 operation,
                                            struct menuitem *item,
                                            union handlerdata *data) {
  char *name = data->keyboard.string;
  s32 i;
...
MenuItemHandlerResult menuhandlerMpTeamNameSlot(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
char *func0f17e318(struct menudialogdef *dialogdef) {
  sprintf(g_StringPointer, langGet(L_MPMENU_056),
 ...
 */
MenuItemHandlerResult menuhandler0017e38c(s32 operation, struct menuitem *item,
                                          union handlerdata *data) {
  if (operation == MENUOP_SET) {
#if VERSION >= VERSION_NTSC_1_0
...
MenuDialogHandlerResult menudialog0017e3fc(s32 operation,
                                           struct menudialogdef *dialogdef,
                                           union handlerdata *data) {
  switch (operation) {
  case MENUOP_OPEN:
    ...
    g_Menus[g_MpPlayerNum].training.mpconfig =
        challengeLoadBySlot(g_Menus[g_MpPlayerNum].training.unke1c,
...
struct menudialogdef g_MpSelectTunesMenuDialog = {
    MENUDIALOGTYPE_DEFAULT,    (uintptr_t)&mpMenuTextSelectTuneOrTunes,
    g_MpSelectTunesMenuItems,  menudialogMpSelectTune,
    MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
struct menudialogdef g_MpTeamNamesMenuDialog = {
    ...
    g_MpTeamNamesMenuItems, NULL, MENUDIALOGFLAG_MPLOCKABLE, NULL,
};
...
struct menudialogdef g_MpConfirmChallengeMenuDialog = {
    MENUDIALOGTYPE_DEFAULT,        (uintptr_t)&func0f17e318,
    g_MpConfirmChallengeMenuItems, menudialog0017e3fc,
    MENUDIALOGFLAG_STARTSELECTS,   NULL,
};

MenuItemHandlerResult mpChallengesListMenuHandler(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  Gfx *gdl;
  struct menuitemrenderdata *renderdata;
  ...
  case MENUOP_RENDER:
    ...
    gdl = text0f153628(gdl);
    gdl = textRenderProjected(
        gdl, &x, &y, challengeGetNameBySlot(data->type19.unk04),
    ...
    for (i = 0; i < maxchrs; i++) {
#if VERSION >= VERSION_NTSC_1_0
      if (challengeIsCompletedByAnyChrWithNumPlayersBySlot(data->type19.unk04,
                                                           i + 1)) {
        gDPSetEnvColorViaWord(gdl++, (renderdata->colour & 0xff) * 0xff >> 8 |
                                         0xffe56500);
      } else {
        gDPSetEnvColorViaWord(gdl++, (renderdata->colour & 0xff) * 0xff >> 8 |
                                         0x43430000);
      ...
      gSPTextureRectangle(gdl++, ((renderdata->x + marginleft) << 2) * g_ScaleX,
                          (renderdata->y + 11) << 2,
                          ((renderdata->x + marginleft + 11) << 2) * g_ScaleX,
                          (renderdata->y + 22) << 2, G_TX_RENDERTILE, 0, 0x0160,
                          1024 / g_ScaleX, -1024);
 ...
 */
MenuItemHandlerResult menuhandler0017e9d8(s32 operation, struct menuitem *item,
                                          union handlerdata *data) {
  if (operation == MENUOP_CHECKHIDDEN) {
    if (g_BossFile.locktype != MPLOCKTYPE_CHALLENGE) {
      return true;
...
MenuItemHandlerResult menuhandlerMpAbortChallenge(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  if (operation == MENUOP_CHECKHIDDEN) {
    if (g_BossFile.locktype != MPLOCKTYPE_CHALLENGE) {
...
MenuItemHandlerResult menuhandlerMpStartChallenge(s32 operation,
                                                  struct menuitem *item,
                                                  union handlerdata *data) {
  if (operation == MENUOP_CHECKHIDDEN) {
    if (g_BossFile.locktype != MPLOCKTYPE_CHALLENGE) {
...
MenuDialogHandlerResult
mpCombatChallengesMenuDialog(s32 operation, struct menudialogdef *dialogdef,
                             union handlerdata *data) {
  if (operation == MENUOP_TICK) {
    if (g_BossFile.locktype == MPLOCKTYPE_CHALLENGE &&
      ...
      challengeLoadAndStoreCurrent(g_Menus[g_MpPlayerNum].menumodel.allocstart,
                                   g_Menus[g_MpPlayerNum].menumodel.alloclen);
    }
  }
...
MenuItemHandlerResult menuhandler0017ec64(s32 operation, struct menuitem *item,
                                          union handlerdata *data) {
  if (operation == MENUOP_SET) {
    challengeSetCurrentBySlot(g_Menus[g_MpPlayerNum].mpsetup.slotindex);
    menuSaveAndRecordPrevMenuRoot(&g_MpQuickGoMenuDialog, MENUROOT_MPSETUP);
...
MenuItemHandlerResult menuhandlerMpLock(s32 operation, struct menuitem *item,
                                        union handlerdata *data) {
  u16 labels[] = {
      L_MPMENU_045, // "None"
  ...
  case MENUOP_GETSELECTEDINDEX:
    data->dropdown.value =
        mpGetLockType() == MPLOCKTYPE_CHALLENGE ? 0 : mpGetLockType();
    break;
  }
...
MenuItemHandlerResult menuhandlerMpSavePlayer(s32 operation,
                                              struct menuitem *item,
                                              union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
MenuItemHandlerResult menuhandler0017ef30(s32 operation, struct menuitem *item,
                                          union handlerdata *data) {
  if (operation == MENUOP_SET) {
    if (g_Vars.stagenum == STAGE_CITRAINING) {
      if (IS4MB()) {
        menuSaveAndRecordPrevMenuRoot(&g_CiMenuViaPauseMenuDialog,
                                      MENUROOT_MAINMENU);
      } else {
        menuSaveAndRecordPrevMenuRoot(&g_CiMenuViaPcMenuDialog,
                                      MENUROOT_MAINMENU);
      }
    } else {
      menuSaveAndRecordPrevMenuRoot(&g_SoloMissionPauseMenuDialog,
                                    MENUROOT_MAINMENU);
    }
  }
...
MenuItemHandlerResult menuhandlerMpSaveSettings(s32 operation,
                                                struct menuitem *item,
                                                union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
MenuDialogHandlerResult menudialogMpGameSetup(s32 operation,
                                              struct menudialogdef *dialogdef,
                                              union handlerdata *data) {
  if (operation == MENUOP_OPEN) {
...
MenuDialogHandlerResult menudialogMpQuickGo(s32 operation,
                                            struct menudialogdef *dialogdef,
                                            union handlerdata *data) {
  if (operation == MENUOP_OPEN) {
...
MenuItemHandlerResult menuhandlerMpFinishedSetup(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
#if VERSION >= VERSION_NTSC_1_0
  if (operation == MENUOP_CHECKPREFOCUSED) {
...
MenuItemHandlerResult menuhandlerQuickTeamSeparator(s32 operation,
                                                    struct menuitem *item,
                                                    union handlerdata *data) {
  if (operation == MENUOP_CHECKHIDDEN) {
...
MenuItemHandlerResult menuhandlerPlayerTeam(s32 operation,
                                            struct menuitem *item,
                                            union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
...
MenuItemHandlerResult menuhandlerMpNumberOfSimulants(s32 operation,
                                                     struct menuitem *item,
                                                     union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
    data->dropdown.value =
        !challengeIsFeatureUnlocked(MPFEATURE_8BOTS) ? 4 : MAX_BOTS;
    break;
  case MENUOP_GETOPTIONTEXT:
...
MenuItemHandlerResult menuhandlerMpSimulantsPerTeam(s32 operation,
                                                    struct menuitem *item,
                                                    union handlerdata *data) {
  switch (operation) {
  case MENUOP_GETOPTIONCOUNT:
...
MenuItemHandlerResult
mpQuickTeamSimulantDifficultyHandler(s32 operation, struct menuitem *item,
                                     union handlerdata *data) {
  s32 count = 0;
  s32 i;
...
MenuItemHandlerResult menuhandlerMpQuickTeamOption(s32 operation,
                                                   struct menuitem *item,
                                                   union handlerdata *data) {
  if (operation == MENUOP_SET) {
...
MenuDialogHandlerResult
menudialogCombatSimulator(s32 operation, struct menudialogdef *dialogdef,
                          union handlerdata *data) {
  if (operation == MENUOP_OPEN) {
  ...
  if (g_Menus[g_MpPlayerNum].curdialog &&
      g_Menus[g_MpPlayerNum].curdialog->definition ==
...
MenuItemHandlerResult menuhandlerMpAdvancedSetup(s32 operation,
                                                 struct menuitem *item,
                                                 union handlerdata *data) {
  if (operation == MENUOP_SET) {
    menuSaveAndRecordPrevMenuRoot(&g_MpAdvancedSetupMenuDialog,
                                  MENUROOT_MPSETUP);
  }
        ...
        for (j = 0; j < g_Menus[g_MpPlayerNum].depth; j++) {
          ...
          for (k = 0; k < g_Menus[g_MpPlayerNum].layers[j].numsiblings; k++) {
            if (g_Menus[g_MpPlayerNum].layers[j].siblings[k]) {
              struct menudialogdef *dialogdef =
                  g_Menus[g_MpPlayerNum].layers[j].siblings[k]->definition;

              if (dialogdef == &g_MpSaveSetupNameMenuDialog)
                ok = false;
              if (dialogdef == &g_MpSaveSetupExistsMenuDialog)
                ok = false;
              if (dialogdef == &g_MpAddSimulantMenuDialog)
                ok = false;
              if (dialogdef == &g_MpChangeSimulantMenuDialog)
                ok = false;
              if (dialogdef == &g_MpEditSimulantMenuDialog)
                ok = false;
              if (dialogdef == &g_MpCombatOptionsMenuDialog)
                ok = false;
              if (dialogdef == &g_HtbOptionsMenuDialog)
                ok = false;
              if (dialogdef == &g_CtcOptionsMenuDialog)
                ok = false;
              if (dialogdef == &g_KohOptionsMenuDialog)
                ok = false;
              if (dialogdef == &g_HtmOptionsMenuDialog)
                ok = false;
              if (dialogdef == &g_PacOptionsMenuDialog)
                ok = false;
            }
          }
        }
...
struct menudialogdef g_MpAbortMenuDialog = {
    MENUDIALOGTYPE_DANGER,
    L_MPMENU_052, // "Abort"
    g_MpAbortMenuItems,    NULL, 0, NULL,
};
...
void mpDecidePlayerMenuAndPush(s32 silent, s32 playernum) {
  ...
  if (g_MenuData.root == MENUROOT_TEAMMISSIONS ||
    ...
    menuPushRootDialog(&g_MpChallengeListOrDetailsViaAdvChallengeMenuDialog,
                       MENUROOT_MPSETUP);
  } else {
...
struct menudialogdef g_ExtGameOptionsMenuDialog = {
    MENUDIALOGTYPE_DEFAULT,      (uintptr_t)"More Options\n",
    g_MpExtGameOptionsMenuItems, NULL,
    MENUDIALOGFLAG_LITERAL_TEXT, NULL,
};
