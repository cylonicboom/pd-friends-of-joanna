...
const char var7f1b63a0[] =
    "RWI : Cam Alloc : Guid=%d -> Total = %u (%d at %s)\n";
...
u16 var8007f904[] = {
    0x0200, 0x0233, 0x024e, 0x026b, 0x0289, 0x02a9, 0x02ca, 0x02ed, 0x0312,
    0x0338, 0x0360, 0x038b, 0x03b7, 0x03e5, 0x0416, 0x0449, 0x047f, 0x04b7,
    0x04f2, 0x0530, 0x0570, 0x05b4, 0x05fc, 0x0646, 0x0695, 0x06e7, 0x073d,
    0x0798, 0x07f7, 0x085a, 0x08c3, 0x0930, 0x09a3, 0x0a1b, 0x0a9a, 0x0b1e,
    0x0ba9, 0x0c3b, 0x0cd4, 0x0d74, 0x0e1c, 0x0ecc, 0x0f85, 0x1047, 0x1113,
    0x11e8, 0x12c8, 0x13b3, 0x14a9, 0x15ab, 0x16ba, 0x17d6, 0x18ff, 0x1a38,
    0x1b7f, 0x1cd7, 0x1e3f, 0x1fb9, 0x2146, 0x22e6, 0x249a, 0x2663, 0x2843,
    0x2a3a, 0x2c49, 0x2e73, 0x30b7, 0x3318, 0x3596, 0x3834, 0x3af2, 0x3dd3,
    0x40d7, 0x4402, 0x4753, 0x4acf, 0x4e75, 0x524a, 0x564e, 0x5a84, 0x5eef,
    0x6392, 0x686e, 0x6d87, 0x72df, 0x787a, 0x7e5c, 0x8487, 0x8aff, 0x91c7,
    0x98e5, 0xa05b, 0xa82f, 0xb065, 0xb901, 0xc208, 0xcb81, 0xd570, 0xdfdb,
    0xeac8, 0xf63d, 0xffff,
};

u32 var8007f9d0 = 0x00000000;

/**
 * Fill the texture buffer with a linear gradient: black (left) to white
 * (right).
 */
 ...
 * 3 returns "Style 4"
 */
char *phGetStyleName(s32 stylenum) { return langGet(L_MISC_429 + stylenum); }
 ...
 */
char *phGetColourName(s32 colournum) { return langGet(L_MISC_433 + colournum); }

struct var8007f8dc *func0f14a20c(void) { return &var8007f8dc[func0f14a5a4()]; }
...
void func0f14a404(void) { func0f149e58(NULL, 0); }
...
void func0f14a594(s32 arg0) { var800a45a0->unk000 = arg0; }

s32 func0f14a5a4(void) { return var800a45a0->unk000; }
...
void func0f14a5e4(void) { func0f14def0(-1, 1407, "camdraw.c"); }
...
s32 func0f14a668(void) { return var800a45a0->unk004; }
...
void func0f14abd4(s32 index, s32 arg1) { var8007f8dc[index].unk06c = arg1; }

s32 func0f14abf4(s32 index) { return var8007f8dc[index].unk06c; }
...
u16 func0f14ad14(s32 device) { return var8007f8dc[device].unk05c & 0xffff; }

s32 func0f14ad38(s32 device) { return var8007f8dc[device].unk060; }

const char var7f1b6688[] = "Cam_ClearCameraLoadBuffer -> Camera=%d\n";
const char var7f1b66b0[] =
...
bool func0f14aea0(s32 device) { return var8007f8dc[device].unk0d4_03; }
...
bool func0f14b484(s32 index) {
  ...
  thing->unk040 = -thing->unk004 * ((thing->unk010 * -1.0f * thing->unk018) +
                                    thing->unk008 * thing->unk01c +
                                    thing->unk00c * thing->unk014);
...
void func0f14b8ac(s32 index) {
  ...
  if (pak0f11d3f8(func0f14a5a4())) {
    ...
    if (thing->unk0f8 == 0 &&
        var8007f8dc[var800a45a0->unk000].unk0d4_04 == false) {
...
const char var7f1b68cc[] =
    "CD_TransferCurrentCacheToEditorAndExit : Player=%d, pD->CamRdImg=%d\n";
const char var7f1b6914[] =
    "Camera -> CD_CycleHandleRead - Need to load up the camera header\n";
const char var7f1b6958[] = "Camera -> CD_CycleHandleRead - Image %d needs "
                           "loading for editor coppying on menu exit\n";
const char var7f1b69b0[] =
    "Camera -> CD_CycleHandleRead - Error ekCamReadModeExit2 in Null cycle\n";
const char var7f1b69f8[] =
...
const char var7f1b6a54[] =
    "RWI : Warning -> Not copying the thumbnail texture\n";
const char var7f1b6a88[] = "CD_DrawTexture : pTex=%x\n";
const char var7f1b6aa4[] = "Cam -> WARNING - Not done intensity table recalc "
                           ":- No samples within threshold\n";
const char var7f1b6af8[] = "Camera -> Call to reset auto calibrate\n";
const char var7f1b6b20[] =
...
void func0f14c50c(struct var8007f8e0 *dst, struct var8007f8e0 *src, u32 line,
                  char *file) {
  struct var8007f8e0 *thing;
  s32 i;
  s32 j;
...
Gfx *func0f14c870(Gfx *gdl, struct textureconfig *tconfig, f32 *arg2, f32 arg3,
                  f32 arg4) {
  ...
  gSPTextureRectangle(gdl++, x * g_ScaleX, y, width * g_ScaleX, height,
                      G_TX_RENDERTILE, 16, sp28,
                      (s32)(1024.0f / arg3) / g_ScaleX, (s32)(1024.0f / arg4));
...
void func0f14d4f0(u8 *src, u8 *dst) {
  ...
  f32 sp50[] = {
      0.0029690000228584f, 0.013306000269949f,  0.021937999874353f,
      0.013306000269949f,  0.0029690000228584f, 0.013306000269949f,
      0.059634000062943f,  0.098319999873638f,  0.059634000062943f,
      0.013306000269949f,  0.021937999874353f,  0.098319999873638f,
      0.16210299730301f,   0.098319999873638f,  0.021937999874353f,
      0.013306000269949f,  0.059634000062943f,  0.098319999873638f,
      0.059634000062943f,  0.013306000269949f,  0.0029690000228584f,
      0.013306000269949f,  0.021937999874353f,  0.013306000269949f,
      0.0029690000228584f,
  };
...
void func0f14d714(u8 *arg0, u8 *arg1) {
  ...
  for (y = 0; y < 63; y++) {
    for (x = 0; x < 63; x++) {
      f32 value =
          (arg0[y * 256 + x * 2] + arg0[y * 256 + x * 2 + 1] +
           arg0[y * 256 + x * 2 + 0x80] + arg0[y * 256 + x * 2 + 0x81]) *
          0.25f;
...
void func0f14dc30(s32 index, bool arg1) {
  ...
  for (y = 0; y < 64; y++) {
    for (j = 0; j < 64; j++) {
      ...
      thing->unk004.textureptr[(u32)(63 - y) * 64 + j +
                               (((u32)(63 - y) & 1) ? ((j & 4) ? -4 : 4) : 0)] =
          f12;
    }
  }
}
...
s32 func0f14dfc0(struct var8007f8e0 *arg0, s32 arg1, s32 arg2) {
  ...
  sp28[0] = *(arg0->unk004.textureptr + arg2 * 64 +
              ((arg2 & 1) ? ((arg1 & 4) ? -4 : 4) : 0) + arg1);
  sp28[1] = *(arg0->unk004.textureptr + (arg2 - 1) * 64 +
              (((arg2 - 1) & 1) ? ((arg1 & 4) ? -4 : 4) : 0) + arg1);
  sp28[2] = *(arg0->unk004.textureptr + arg2 * 64 +
              ((arg2 & 1) ? (((arg1 - 1) & 4) ? -4 : 4) : 0) + arg1 - 1);
  sp28[3] = *(arg0->unk004.textureptr + (arg2 + 1) * 64 +
              (((arg2 + 1) & 1) ? ((arg1 & 4) ? -4 : 4) : 0) + arg1);
  sp28[4] = *(arg0->unk004.textureptr + arg2 * 64 +
              ((arg2 & 1) ? (((arg1 + 1) & 4) ? -4 : 4) : 0) + arg1 + 1);
...
void func0f14e1c4(struct var8007f8e0 *arg0) {
  ...
  for (f20 = 0.0f; f20 < f22; f20 += 1.0f) {
    ...
    for (i = 0; i < size; i++) {
      ...
      arg0->unk004
          .textureptr[y1 * 64 + x1 + ((y1 & 1) ? ((x1 & 4) ? -4 : 4) : 0)] =
          value1;
      arg0->unk004
          .textureptr[y2 * 64 + x1 + ((y2 & 1) ? ((x1 & 4) ? -4 : 4) : 0)] =
          value1;
      arg0->unk004
          .textureptr[y1 * 64 + x2 + ((y1 & 1) ? ((x2 & 4) ? -4 : 4) : 0)] =
          value2;
      arg0->unk004
          .textureptr[y2 * 64 + x2 + ((y2 & 1) ? ((x2 & 4) ? -4 : 4) : 0)] =
          value2;
    }
  }
}
...
void func0f14e884(struct textureconfig *tconfig, s32 numrows, s32 arg2,
                  u64 arg3) {
  s32 sp5c;
  s32 numbytes;
  s32 bitsperpixel;
...
Gfx *func0f14eb04(Gfx *gdl, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5) {
  ...
  gdl = func0f14c870(gdl, &thing->unk004, sp30, (arg4 - arg2) * 0.015625f,
                     (arg5 - arg3) * 0.015625f);
...
Gfx *func0f14eb98(Gfx *gdl, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5) {
  ...
  gdl = func0f14c870(gdl, &thing->unk010, sp30, (arg4 - arg2) * 0.0625f,
                     (arg5 - arg3) * 0.0625f);
...
void func0f14ed38(void) { func0f14ec2c(10, 3, 54, 61); }
...
const char var7f1b6da4[] = "CAM : Cam_AllocAndCopyAllVtx -> Ptr all-ready "
                           "allocted - No extra needed\n";
...
void func0f14f03c(s32 index, s32 value) { var8007f8dc[index].unk074 = value; }

s32 func0f14f05c(s32 index) { return var8007f8dc[index].unk074; }
...
Gfx *func0f14f07c(Gfx *gdl, s32 headorbodynum, s32 x1, s32 y1, s32 x2, s32 y2) {
  ...
  if (func0f14a20c()->unk0b6[headorbodynum] != 0xff) {
    if (func0f14a20c()->unk0dc[headorbodynum] == 0) {
      gdl =
          func0f14c870(gdl, var800a45a0->unk488, sp34,
                       (x2 - x1) * (1.0f / 64.0f), (y2 - y1) * (1.0f / 64.0f));
    } else {
      gdl = func0f14c870(gdl, thing, sp34, (x2 - x1) * (1.0f / 64.0f),
                         (y2 - y1) * (1.0f / 64.0f));
    }
  }
...
s32 func0f14f2b4(struct modeldef *modeldef, Vtx **dst, u32 *len) {
  ...
  if (node1 && node2 && node3) {
    ...
    memcpy(*dst + node1numverts, node2rodata->vertices,
           node2numverts * sizeof(Vtx));
    memcpy(*dst + node1numverts + node2numverts, node3rodata->vertices,
           node3numverts * sizeof(Vtx));
...
const char var7f1b6e90[] =
    "Cam -> Cam_SquashOnePart - pExtents=%08x, pVcopy=%08x, \n";
const char var7f1b6ecc[] =
    "Cam -> Cam_SquashOnePart - Head centre at (%d,%d,%d)\n";
const char var7f1b6f04[] =
    "Cam -> Cam_SquashOnePart - Scale Param 1 = %s%s%.3f\n";
const char var7f1b6f3c[] = "";
const char var7f1b6f40[] = "";
const char var7f1b6f44[] =
    "Cam -> Cam_SquashOnePart - Scale Param 2 = %s%s%.3f\n";
const char var7f1b6f7c[] = "";
const char var7f1b6f80[] = "";
const char var7f1b6f84[] =
    "Cam -> Cam_SquashOnePart - Scale Param 3 = %s%s%.3f\n";
const char var7f1b6fbc[] = "";
const char var7f1b6fc0[] = "";
const char var7f1b6fc4[] =
    "Cam -> Cam_SquashOnePart - Scale Param 4 = %s%s%.3f\n";
const char var7f1b6ffc[] = "";
const char var7f1b7000[] = "";
const char var7f1b7004[] =
    "Cam -> Cam_SquashOnePart - Scale Param 5 = %s%s%.3f\n";
const char var7f1b703c[] = "";
const char var7f1b7040[] = "";
const char var7f1b7044[] =
    "Cam -> Cam_SquashOnePart - Scale Param 6 = %s%s%.3f\n";
const char var7f1b707c[] = "";
const char var7f1b7080[] = "";
const char var7f1b7084[] =
    "Cam -> Cam_SquashOnePart - Scale Param 7 = %s%s%.3f\n";
...
const char var7f1b7104[] = "Cam_LoadFromPakIntoSlot -> Pak=%d, fileGuid=%u, "
                           "pakGuid=%u, Slot=%d, pS=%x, pE=%x\n";
...
u32 func0f14f4a0(u32 arg0) { return arg0; }
...
s32 pheadSaveFile(s8 device, s32 fileid, u16 serial) {
  ...
  ret = pakSaveAtGuid(device, fileid, PAKFILETYPE_CAMERA, (u8 *)&file,
                      &writtenfileid, NULL);
