...
struct chrbio *ciGetChrBio(struct biocharid *ch)
{
	...
	struct chrbio bios[] = {
		...
		/*4*/ { (uintptr_t)"Calico Dark", (uintptr_t)"dD-200x Replicant (Female)", (uintptr_t)"27 (apparent)", (uintptr_t)"|CI File #141 -\n\nTraining Status: N/A\nTraining Grade: N/A\nActive Status: Unassigned\nManufacturer: dataDyne\n\n|Profile -\n\nExperimental dataDyne protoype unit. A composite of experiential modules harvested from anonymous internet engramboards. It was fitted with self-replicating neurotic modules intended to render it docile and subservient to its human handlers. Handlers unavailable for interview: dataDyne records indicate this unit killed its handlers during a botched affinity calibration sequence. Caution is advised when interacting with this agent.\n", CHRBIO_FLAG_LITERAL },
