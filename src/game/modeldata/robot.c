...
struct headorbody g_HeadsAndBodiesOriginal[] = {
	//           ismale
	//           |                                  height
	//           |                                  |
...
struct headorbody *g_HeadsAndBodies = g_HeadsAndBodiesOriginal;
s32 g_NumHeadsAndBodies = ARRAYCOUNT(g_HeadsAndBodiesOriginal);
const s32 g_NumHeadsAndBodies_Original = ARRAYCOUNT(g_HeadsAndBodiesOriginal);
